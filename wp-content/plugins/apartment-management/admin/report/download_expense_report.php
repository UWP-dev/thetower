				...
				<tbody>
				 <?php 
					if(isset($_POST['download_report']))
					{
						...
						$result = $wpdb->get_results("select * from $table_name where created_date BETWEEN '$sdate' AND '$edate' AND type='expense'"); 
					}
					if(!empty($result))
					{
						$i=1;
						...
						{ 
							...
							<tr>
								...
								<td class="end_date"><?php echo esc_html(get_the_title($retrieved_data->type_id)); ?></td>
								<td class="end_date"><?php echo esc_html($retrieved_data->vender_name); ?></td>
								<td class="end_date"><?php echo esc_html($retrieved_data->amount); ?></td>
								<td class="end_date"><?php echo esc_html($retrieved_data->payment_date); ?></td>
							</tr>
							<?php
							$i++;
						}
