				...
				<div class="panel panel-white"><!--PANEL WHITE -->
					<div class="panel-body"><!-- PANEL BODY-->
						...
						<h2 class="nav-tab-wrapper report-tab">
							...
							class="nav-tab <?php echo esc_html($active_tab) == 'unit_by_building' ? 'nav-tab-active' : ''; ?>">
							...
							class="nav-tab <?php echo esc_html($active_tab) == 'member_by_building' ? 'nav-tab-active' : ''; ?>">
							...
							class="nav-tab <?php echo esc_html($active_tab) == 'payment' ? 'nav-tab-active' : ''; ?>">
							<?php echo '<span class="dashicons dashicons-menu"></span> '.esc_html__('Payment', 'apartment_mgt'); ?></a>
							<a href="?page=amgt-report&tab=expense" 
							class="nav-tab <?php echo esc_html($active_tab) == 'expense' ? 'nav-tab-active' : ''; ?>">
							...
							class="nav-tab <?php echo esc_html($active_tab) == 'complaint' ? 'nav-tab-active' : ''; ?>">
							<?php echo '<span class="dashicons dashicons-menu"></span> '.esc_html__('Complaint Status', 'apartment_mgt'); ?>
							</a>
							<a href="?page=amgt-report&tab=download_income_expense_report" 
							class="nav-tab <?php echo esc_html($active_tab) == 'download_income_expense_report' ? 'nav-tab-active' : ''; ?>">
							<?php echo '<span class="dashicons dashicons-menu"></span> '.esc_html__('Download Income Report', 'apartment_mgt'); ?>
							</a>
							<a href="?page=amgt-report&tab=download_expense_report" 
							class="nav-tab <?php echo esc_html($active_tab) == 'download_expense_report' ? 'nav-tab-active' : ''; ?>">
							<?php echo '<span class="dashicons dashicons-menu"></span> '.esc_html__('Download Expense Report', 'apartment_mgt'); ?>
							</a>
