				...
				success: function(data){	
					...
					{ 
					  ...
					  $('.unnit_measurement').val('');	
			           $('.unnit_chanrges').val('');
					  $('.modal').modal('hide');
					  window.location = "?page=amgt-member&tab=memberlist&message=1";
					}
...
<?php 
	...
	{		
		...
		{	
			...
			{
				$result=$obj_units->MJ_amgt_delete_all_unit($id);
					...
					<div class="panel-body"><!--PANEL BODY-->
						...
						<h2 class="nav-tab-wrapper">
						   <?php $unit_type=get_option( 'amgt_apartment_type' );?>
							<a href="?page=amgt-residential_unit&tab=unitlist" class="nav-tab <?php echo esc_html($active_tab) == 'unitlist' ? 'nav-tab-active' : ''; ?>">
							...
							{ ?>
							<a href="?page=amgt-residential_unit&tab=addunit&action=edit&unit_name=<?php echo $_REQUEST['unit_name'];?>&unit_id=<?php echo $_REQUEST['unit_id'];?>&index=<?php echo $_REQUEST['index']; ?>" class="nav-tab <?php echo esc_html($active_tab) == 'addunit' ? 'nav-tab-active' : ''; ?>">
							<?php 
							if($unit_type == 'Residential')
							{	
							...
							{ ?>
								<a href="?page=amgt-residential_unit&tab=addunit" class="nav-tab <?php echo esc_html($active_tab) == 'addunit' ? 'nav-tab-active' : ''; ?>">
													...
													foreach ($residentialdata as $retrieved_data)
													{
															...
															foreach($units_data as $unit)
															{
																...
																<tr>
																	...
																	<td class="building">
																	<?php $building = get_post($retrieved_data->building_id); echo  esc_html($building->post_title);?></td>
																	...
																	<?php } else {?>
																	<button type="button" class="btn btn-default margin_top_min_5 remove_unused_model" data-bs-toggle="modal" data-bs-target="#myModal_add_member"><i class="fa fa-plus-circle"></i> <?php esc_html_e('Add Member', 'apartment_mgt' ) ;?></button>
																	 <?php } ?>
      ...
      <div class="modal-content"><!--MODAL CONTENT -->
		...
		<div class="form-group">
			<div class="mb-3 row">	
				...
				<div class="col-sm-2">
					<button type="button" class="btn btn-default myModal_add_building_model remove_unused_model" data-bs-toggle="modal" data-bs-target="#myModal_add_building"> <?php esc_html_e('Add Building','apartment_mgt');?></button>				
				</div>
			</div>
		</div>		
		<div id="hello"></div>
		...
		<div class="form-group">
			<div class="mb-3 row">	
				...
				<div class="col-sm-1">
					<div class="col-sm-1">
					<input id="committee_member" class="form-control text-input" type="checkbox" <?php if($edit==1 && $result->committee_member=='yes'){ echo "checked='checked'";}?> name="committee_member" 
					value="yes"></div>	
				</div>	
      ...
      <div class="modal-content">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				...
				<div class="col-sm-2"><button class="btn btn-default remove_unused_model" id="addremove" model="building_category"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button></div>
			</div>	
		</div>
		<div class="form-group">
			<div class="mb-3 row">	
