...
<div class="page-inner min_height_1631">
	...
	<div class="page-title">
		<h3><img src="<?php echo esc_url(get_option( 'amgt_system_logo' )) ?>" class="img-circle head_logo" width="40" height="40" /><?php echo esc_html(get_option( 'amgt_system_name' ));?></h3>
	</div>
	<!-- Page Title div end -->
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				<h2 class="nav-tab-wrapper">
					<a href="?page=amgt-access_right&tab=Member" class="nav-tab <?php echo esc_html($active_tab) == 'Member' ? 'nav-tab-active' : ''; ?>">
					<?php echo '<span class="dashicons dashicons-menu"></span>'.esc_html__('Member', 'apartment_mgt'); ?></a>

					<a href="?page=amgt-access_right&tab=Staff_Member" class="nav-tab <?php echo esc_html($active_tab) == 'Staff_Member' ? 'nav-tab-active' : ''; ?>">
					<?php echo '<span class="dashicons dashicons-menu"></span>'.esc_html__('Staff Member', 'apartment_mgt'); ?></a> 
			 
					<a href="?page=amgt-access_right&tab=Accountant" class="nav-tab <?php echo esc_html($active_tab) == 'Accountant' ? 'nav-tab-active' : ''; ?>">
					<?php echo '<span class="dashicons dashicons-menu"></span>'.esc_html__('Accountant', 'apartment_mgt'); ?></a> 
			  
					<a href="?page=amgt-access_right&tab=Gatekeeper" class="nav-tab <?php echo esc_html($active_tab) == 'Gatekeeper' ? 'nav-tab-active' : ''; ?>">
