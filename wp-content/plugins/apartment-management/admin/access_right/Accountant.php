 <?php 	
$result=get_option('amgt_access_right_accountant');
if(isset($_POST['save_access_right']))
{
	...
	$result=update_option( 'amgt_access_right_accountant',$role_access_right);
	wp_redirect ( admin_url() . 'admin.php?page=amgt-access_right&tab=Accountant&message=1');
}
$access_right=get_option('amgt_access_right_accountant');
?>	
<div class="panel panel-white"><!--- PANEL WHITE DIV START -->
		<h2>
			<?php esc_html_e('Accountant Access Right', 'apartment_mgt'); ?>
		</h2>			
				...
				<div class="access_right_menucroll row border_bottom_0">
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['resident_unit']['own_data'],1);?> value="1" name="resident_unit_own_data">	              
								</label> 
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['resident_unit']['view'],1);?> value="1" name="resident_unit_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['resident_unit']['add'],1);?> value="1" name="resident_unit_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['resident_unit']['edit'],1);?> value="1" name="resident_unit_edit" disabled>	              
								</label>
							</div>
						</div>
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_15_min margin_left_20_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['resident_unit']['delete'],1);?> value="1" name="resident_unit_delete" disabled>	              
								</label>
							</div>
						</div>								
					</div>							
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['committee-member']['own_data'],1);?> value="1" name="committee-member_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['committee-member']['view'],1);?> value="1" name="committee-member_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_10 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['committee-member']['add'],1);?> value="1" name="committee-member_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['committee-member']['edit'],1);?> value="1" name="committee-member_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['committee-member']['delete'],1);?> value="1" name="committee-member_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['staff-members']['own_data'],1);?> value="1" name="staff-members_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['staff-members']['view'],1);?> value="1" name="staff-members_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['staff-members']['add'],1);?> value="1" name="staff-members_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['staff-members']['edit'],1);?> value="1" name="staff-members_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['staff-members']['delete'],1);?> value="1" name="staff-members_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gatekeeper']['own_data'],1);?> value="1" name="gatekeeper_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gatekeeper']['view'],1);?> value="1" name="gatekeeper_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gatekeeper']['add'],1);?> value="1" name="gatekeeper_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gatekeeper']['edit'],1);?> value="1" name="gatekeeper_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['gatekeeper']['delete'],1);?> value="1" name="gatekeeper_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['visitor-manage']['own_data'],1);?> value="1" name="visitor-manage_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['visitor-manage']['view'],1);?> value="1" name="visitor-manage_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['visitor-manage']['add'],1);?> value="1" name="visitor-manage_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['visitor-manage']['edit'],1);?> value="1" name="visitor-manage_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['visitor-manage']['delete'],1);?> value="1" name="visitor-manage_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['notice-event']['own_data'],1);?> value="1" name="notice-event_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['notice-event']['view'],1);?> value="1" name="notice-event_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['notice-event']['add'],1);?> value="1" name="notice-event_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['notice-event']['edit'],1);?> value="1" name="notice-event_edit" >	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['notice-event']['delete'],1);?> value="1" name="notice-event_delete" >	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['complaint']['own_data'],1);?> value="1" name="complaint_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['complaint']['view'],1);?> value="1" name="complaint_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['complaint']['add'],1);?> value="1" name="complaint_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['complaint']['edit'],1);?> value="1" name="complaint_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['complaint']['delete'],1);?> value="1" name="complaint_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['parking-manager']['own_data'],1);?> value="1" name="parking-manager_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['parking-manager']['view'],1);?> value="1" name="parking-manager_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['parking-manager']['add'],1);?> value="1" name="parking-manager_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['parking-manager']['edit'],1);?> value="1" name="parking-manager_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['parking-manager']['delete'],1);?> value="1" name="parking-manager_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['services']['own_data'],1);?> value="1" name="services_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['services']['view'],1);?> value="1" name="services_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['services']['add'],1);?> value="1" name="services_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['services']['edit'],1);?> value="1" name="services_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['services']['delete'],1);?> value="1" name="services_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['facility']['own_data'],1);?> value="1" name="facility_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['facility']['view'],1);?> value="1" name="facility_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['facility']['add'],1);?> value="1" name="facility_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['facility']['edit'],1);?> value="1" name="facility_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['facility']['delete'],1);?> value="1" name="facility_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['accounts']['own_data'],1);?> value="1" name="accounts_own_data">	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['accounts']['view'],1);?> value="1" name="accounts_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['accounts']['add'],1);?> value="1" name="accounts_add" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['accounts']['edit'],1);?> value="1" name="accounts_edit" >	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['accounts']['delete'],1);?> value="1" name="accounts_delete" >	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['documents']['own_data'],1);?> value="1" name="documents_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['documents']['view'],1);?> value="1" name="documents_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['documents']['add'],1);?> value="1" name="documents_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['documents']['edit'],1);?> value="1" name="documents_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['documents']['delete'],1);?> value="1" name="documents_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['assets-inventory-tracker']['own_data'],1);?> value="1" name="assets-inventory-tracker_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['assets-inventory-tracker']['view'],1);?> value="1" name="assets-inventory-tracker_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['assets-inventory-tracker']['add'],1);?> value="1" name="assets-inventory-tracker_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['assets-inventory-tracker']['edit'],1);?> value="1" name="assets-inventory-tracker_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['assets-inventory-tracker']['delete'],1);?> value="1" name="assets-inventory-tracker_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['profile']['own_data'],1);?> value="1" name="profile_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['profile']['view'],1);?> value="1" name="profile_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['profile']['add'],1);?> value="1" name="profile_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['profile']['edit'],1);?> value="1" name="profile_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['profile']['delete'],1);?> value="1" name="profile_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['faq']['own_data'],1);?> value="1" name="faq_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['faq']['view'],1);?> value="1" name="faq_view" >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['faq']['add'],1);?> value="1" name="faq_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['faq']['edit'],1);?> value="1" name="faq_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['faq']['delete'],1);?> value="1" name="faq_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['society_rules']['own_data'],1);?> value="1" name="society_rules_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['society_rules']['view'],1);?> value="1" name="society_rules_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['society_rules']['add'],1);?> value="1" name="society_rules_add" disabled >	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['society_rules']['edit'],1);?> value="1" name="society_rules_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['society_rules']['delete'],1);?> value="1" name="society_rules_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gallery']['own_data'],1);?> value="1" name="gallery_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gallery']['view'],1);?> value="1" name="gallery_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gallery']['add'],1);?> value="1" name="gallery_add" disabled>	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['accountant']['gallery']['edit'],1);?> value="1" name="gallery_edit" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['accountant']['gallery']['delete'],1);?> value="1" name="gallery_delete" disabled>	              
								<label>
								</label>
							</div>
						</div>								
