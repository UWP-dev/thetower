...
<div class="panel panel-white"><!--- PANEL WHITE DIV START -->
		<h2>
			<?php esc_html_e('Member Access Right', 'apartment_mgt'); ?>
		</h2>			
				...
				<div class="access_right_menucroll row border_bottom_0">
					...
					<div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_20_res">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['member']['report']['own_data'],1);?> value="1" name="report_own_data" disabled>	              
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 menu_left_15">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['member']['report']['view'],1);?> value="1" name="report_view">	              
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['member']['report']['add'],1);?> value="1" name="report_add" disabled>
								</label>
							</div>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_10_min">
							<div class="checkbox">
								<label>
									<input type="checkbox" <?php echo checked($access_right['member']['report']['edit'],1);?> value="1" name="report_edit" disabled>
								</label>
							</div>
						</div>								
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 margin_left_5_res">
							<div class="checkbox">
									<input type="checkbox" <?php echo checked($access_right['member']['report']['delete'],1);?> value="1" name="report_delete" disabled>
								<label>
								</label>
							</div>
						</div>								
