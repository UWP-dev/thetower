...
{    //VISITOR CHECKIN FORM VALIDATIONENGINE
	...
	if (is_rtl())
		{
		?>	
			$('#visitor_checkin_form').validationEngine({promptPosition : "topLeft",maxErrorsPerField: 1});
		<?php
		}
		else{
			?>
	...
	{
		$("#add_visiter_entry_div").append('<div class="row padding_left_10" ><div class="form-group"><div class="mb-3 row"><label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="name"><?php esc_html_e('Visitor Name','apartment_mgt');?><span class="require-field">*</span></label><div class="col-sm-8"><input type="text" value="" class="form-control validate[required,custom[onlyLetter_specialcharacter]] text-input onlyletter_number_space_validation" maxlength="50" name="visitor_name[]"/></div></div></div><div class="form-group"><div class="mb-3 row"><label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="mobile"><?php esc_html_e('ID Number','apartment_mgt');?><span class="require-field">*</span></label><div class="col-sm-3"><input id="mobile" class="form-control validate[required,custom[onlyLetterNumber]] text-input" type="text" maxlength="15" name="mobile[]" value=""></div><label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="vehicle"><?php esc_html_e('Vehicle Number','apartment_mgt');?></label><div class="col-sm-3"><input type="text" value="" maxlength="20" class="form-control text-input" name="vehicle_number[]"/></div></div></div><div class="form-group mb-2"><div class="offset-sm-2 col-lg-8 col-md-8 col-sm-8 col-xs-12"><button type="button" class="btn btn-danger" onclick="deletevisiterentry(this)"><i class="entypo-trash"><?php esc_html_e('Delete','apartment_mgt');?></i></button></div></div></div>');
	});	
		...
		<div class="panel-body"><!----PANEL-BODY--->
			...
			<div class="form-group">
				<div class="mb-3 row">	
					...
					$gatedata=$obj_gate->MJ_amgt_get_all_entry_gates();
					if(!empty($gatedata))
					{
						$i=1;
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="visitreason_category"><?php esc_html_e('Reason For Visit','apartment_mgt');?></label>
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
						<select class="form-select onlyletter_number_space_validation visit_reason_cat visit_reason_append" name="reason_id" maxlength="50" >
						...
						$activity_category=MJ_amgt_get_all_category('visit_reason_cat');
					...
					<!---GENERAL INFORMATION--->
					<div class="col-sm-2"><button class="btn btn-default" id="addremove" model="visit_reason_cat"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button></div>
				</div>	
			</div>
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="activity_category"><?php esc_html_e('Compound','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
						<select class="form-select building_category validate[required] visitor_compound_append" name="building_id">
					...
					<div class="col-sm-2">
					  <button id="add_bulding" type="button" class="btn btn-default remove_unused_model" data-bs-toggle="modal" data-bs-target="#myModal_add_building"> <?php esc_html_e('Add Compound','apartment_mgt');?></button>
					</div>
				</div>
			...
			<div class="form-group">
				<div class="mb-3 row">	
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
						<select class="form-select unit_categorys validate[required] visitor_unit_cat_append" name="unit_cat_id">
			...
			<div class="form-group">
				<div class="mb-3 row">	
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
						<select class="form-select unit_name validate[required] visitor_unit_name_append" name="unit_name">
						...
						if($edit)
						{
							...
							$unitsarray=$obj_units->MJ_amgt_get_single_cat_units($building_id,$result->unit_cat);
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="vehicle"><?php esc_html_e('Visit Date','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-sm-3">
					 ...
					 <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="vehicle"><?php esc_html_e('Visit Time','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-sm-3">
						<input type="text" value="<?php if($edit){ echo esc_attr($result->checkin_time);}elseif(isset($_POST['checkintime'])) echo esc_attr($_POST['checkintime']); else date_default_timezone_set('Asia/Kolkata'); echo date("h:i a");?>" class="form-control timepicker validate[required]" name="checkintime"/ readonly>
					 </div>
				</div>
			</div>
					...
					foreach($all_visiter_entry as $entry1)
					{
						?>	
							<div class="row padding_left_10">
								<div class="form-group">
									<div class="mb-3 row">	
										<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="name"><?php esc_html_e('Visitor Name','apartment_mgt');?><span class="require-field">*</span></label>
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								...
								<div class="form-group">
									<div class="mb-3 row">	
										<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="mobile"><?php esc_html_e('ID Number','apartment_mgt');?><span class="require-field">*</span></label>
										...
										<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="vehicle"><?php esc_html_e('Vehicle Number','apartment_mgt');?></label>
										<div class="col-sm-3">
									...
									<div class="form-group">
										<div class="mb-3 row">	
											<div class="col-sm-offset-2 col-sm-2">
												<button type="button" class="btn btn-danger" onclick="deletevisiterentry(this)">
						...
						<div class="form-group">
							<div class="mb-3 row">	
								...
								<div class="col-sm-6">
								 ...
								 <div class="col-sm-2">
									<button type="button" class="btn btn-info visitor_details_search margin_top_4"><?php esc_html_e('Search','apartment_mgt');?></button>
								 </div>
								</div>
						</div>
						<div class="form-group">
							<div class="mb-3 row">	
								<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="mobile"><?php esc_html_e('ID Number','apartment_mgt');?><span class="require-field">*</span></label>
								<div class="col-sm-3">
									<input id="mobile" class="form-control validate[required,custom[onlyLetterNumber]] text-input visitor_id_number" type="text" maxlength="15"  name="mobile[]" 
									value="">
						...
						<div class="form-group">
							<div class="mb-3 row">	
								...
								<div class="col-sm-3">
									...
									<button id="add_new_entry" class="btn btn-default btn-sm btn-icon icon-left" type="button"   name="add_new_entry" onclick="Add_componts()"><?php esc_html_e('Add More Unit','apartment_mgt'); ?>
									</button>
								</div>
							</div>
						</div>
...
<script>
	...
	var blank_income_entry ='';
   	$(document).ready(function() { 
		...
		//    console.log(blank_expense_entry);
   	}); 

   	function Add_componts()
   	{
