<?php 
$active_tab = sanitize_text_field(isset($_GET['tab'])?$_GET['tab']:'setup');
?>
...
if(isset($_REQUEST['varify_key'])){	//VARIFY_KEY
	$verify_result = MJ_amgt_submit_setupform($_POST);	
...
<?php } ?>
   ...
   <form name="verification_form" action="" method="post" class="form-horizontal" id="verification_form">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="licence_key"><?php esc_html_e('Envato License key','apartment_mgt');?> <span class="require-field">*</span></label>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="enter_email"><?php esc_html_e('Email','apartment_mgt');?> <span class="require-field">*</span></label>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
