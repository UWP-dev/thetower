				...
				<div class="panel panel-white">
					<div class="panel-body"><!--PANEL BODY-->
						<h2 class="nav-tab-wrapper">
							<a href="?page=amgt-gatekeeper&tab=gatekeeper_list" class="nav-tab <?php echo esc_html($active_tab) == 'gatekeeper_list' ? 'nav-tab-active' : ''; ?>">
							...
							{ ?>
							<a href="?page=amgt-gatekeeper&tab=add_gatekeeper&action=edit&member_id=<?php echo $_REQUEST['member_id'];?>" class="nav-tab <?php echo esc_html($active_tab) == 'add_gatekeeper' ? 'nav-tab-active' : ''; ?>">
							<?php esc_html_e('Edit Gatekeeper', 'apartment_mgt'); ?></a>  
							<?php 
							}
							else 
							{ ?>
								<a href="?page=amgt-gatekeeper&tab=add_gatekeeper" class="nav-tab <?php echo esc_html($active_tab) == 'add_gatekeeper' ? 'nav-tab-active' : ''; ?>">
