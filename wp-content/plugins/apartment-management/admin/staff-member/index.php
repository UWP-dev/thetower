<?php 
$active_tab = sanitize_text_field(isset($_GET['tab'])?$_GET['tab']:'staff-memberlist');
				...
				<div class="panel panel-white">
					<div class="panel-body">
							<h2 class="nav-tab-wrapper">
								<a href="?page=amgt-staff_member&tab=staff-memberlist" class="nav-tab <?php echo esc_html($active_tab) == 'staff-memberlist' ? 'nav-tab-active' : ''; ?>">
								...
								{ ?>
								<a href="?page=amgt-staff_member&tab=add_staffmember&action=edit&member_id=<?php echo $_REQUEST['member_id'];?>" class="nav-tab <?php echo esc_html($active_tab) == 'add_staffmember' ? 'nav-tab-active' : ''; ?>">
								<?php esc_html_e('Edit Staff Member', 'apartment_mgt'); ?></a>  
								<?php 
								}
								else 
								{ ?>
									<a href="?page=amgt-staff_member&tab=add_staffmember" class="nav-tab <?php echo esc_html($active_tab) == 'add_staffmember' ? 'nav-tab-active' : ''; ?>">
