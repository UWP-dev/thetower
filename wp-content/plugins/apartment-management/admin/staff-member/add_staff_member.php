		...
		<div class="panel-body">
            <form name="staffmember_form" action="" method="post" class="form-horizontal" id="staffmember_form">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="birth_date" class="form-control validate[required]" type="text" autocomplete="off" name="birth_date" 
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="unit_name"><?php esc_html_e('Staff Category','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-sm-8">
					...
					<div class="col-sm-2"><button id="addremove" model="staff_category"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button></div>
				</div>
					<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label" for="Skills"><?php esc_html_e('Skills','apartment_mgt');?></label>
					<div class="col-sm-8">
						<input id="skills" class="form-control validate[custom[onlyLetterSp]]" maxlength="50" type="text"  value="<?php if($edit){ echo esc_attr($result->skills);}elseif(isset($_POST['skills'])) echo esc_attr($_POST['skills']);?>" name="skills">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						value="<?php if($edit){ echo esc_attr($result->address);}elseif(isset($_POST['address'])) echo $_POST['address'];?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						...
						value="<?php if($edit)echo esc_url( $result->MJ_amgt_user_avatar );elseif(isset($_POST['amgt_user_avatar'])) echo $_POST['amgt_user_avatar']; ?>" readonly />
					</div>	
				   <div class="col-sm-3">
