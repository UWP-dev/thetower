			...
			<form name="document_form" action="" method="post" class="form-horizontal" id="document_form" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="mb-3 row">	
						...
						<button type="button" id="add_bulding" class="btn btn-default remove_unused_model myModal_add_building_model" data-bs-toggle="modal" data-bs-target="#myModal_add_building"> <?php esc_html_e('Add Building','apartment_mgt');?></button>
						</div>
					</div>
				</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content"><!--MODAL CONTENT--->
			<div class="modal-header"><!--MODAL HEADER--->
			  ...
			  <button type="button" class="close btn-close show_member_form" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
                <div class="modal-body"><!--MODAL BODY--->
					<script type="text/javascript">
					$(document).ready(function() {
