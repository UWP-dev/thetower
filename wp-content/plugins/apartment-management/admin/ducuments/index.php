...
<?php 
	...
	{		
		...
		{	
			...
			{
				$result=$obj_document->MJ_amgt_delete_document($id);
	...
	if(isset($_REQUEST['message']))//MESSAGES
	{
		...
		{?><div id="message" class="updated below-h2 notice is-dismissible"><p><?php
					esc_html_e("Document updated successfully.",'apartment_mgt');
					?></p>
					</div>
				<?php 
				...
				<div class="panel panel-white"><!--PANEL-WHITE-->
					<div class="panel-body"><!--PANEL BODY-->
							...
							<h2 class="nav-tab-wrapper">
								<a href="?page=amgt-legal-documents&tab=documentlist" class="nav-tab <?php echo esc_html($active_tab) == 'documentlist' ? 'nav-tab-active' : ''; ?>">
								...
								{ ?>
								<a href="?page=amgt-legal-documents&tab=add_document&action=edit&document_id=<?php echo $_REQUEST['document_id'];?>" class="nav-tab <?php echo esc_html($active_tab) == 'add_document' ? 'nav-tab-active' : ''; ?>">
								<?php esc_html_e('Edit Document', 'apartment_mgt'); ?></a>  
								<?php 
								}
								else 
								{ ?>
									<a href="?page=amgt-legal-documents&tab=add_document" class="nav-tab <?php echo esc_html($active_tab) == 'add_document' ? 'nav-tab-active' : ''; ?>">
					...
					<tbody>
					 ...
					 if(!empty($documentdata))
					 {
						...
						<tr>
							...
							<td class="from"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($retrieved_data->created_date)));?></td>
