	...
	<div class="panel-body"><!--PANEL BODY-->
		...
		<div class="form-group">
			<div class="mb-3 row">	
				...
				<?php esc_html_e('Select Facility To Book','apartment_mgt');?><span class="require-field">*</span></label>
				<?php
				if($edit)
				{
				?>
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">					
						...
						<input class="form-control text-input" type="text" value="<?php echo esc_attr(MJ_amgt_get_facility_name($result->facility_id)); ?>" name="" readonly>
					</div>	
				<?php
				}
				else
				{	
				?>	
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><!---SELECT FACILITY FORM--->
		...
		<div class="form-group"><!--BOOKING FACILITY ON BEHALF OF-->
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="day"><?php esc_html_e('Booking Facility On Behalf Of','apartment_mgt');?></label>	
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
