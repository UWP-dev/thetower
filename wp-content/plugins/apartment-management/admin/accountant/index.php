				...
				<div class="panel panel-white"><!--PANEL WHITE DIV-->
					<div class="panel-body"><!--PANEL BODY-->
							<h2 class="nav-tab-wrapper">
								<a href="?page=amgt-accountant&tab=accountantlist" class="nav-tab <?php echo esc_html($active_tab) == 'accountantlist' ? 'nav-tab-active' : ''; ?>">
								...
								{ ?>
								<a href="?page=amgt-accountant&tab=add_accountant&action=edit&accountant_id=<?php echo $_REQUEST['accountant_id'];?>" class="nav-tab <?php echo esc_html($active_tab) == 'add_accountant' ? 'nav-tab-active' : ''; ?>">
								<?php esc_html_e('Edit Accountant', 'apartment_mgt'); ?></a>  
								<?php 
								}
								else 
								{ ?>
									<a href="?page=amgt-accountant&tab=add_accountant" class="nav-tab <?php echo esc_html($active_tab) == 'add_accountant' ? 'nav-tab-active' : ''; ?>">
