	...
	<div id="main-wrapper"><!--MAIN WRAPPER-->	
		<div class="row mailbox-header"><!--MAILBOX HEADER -->	
			<div class="col-md-2 col-sm-3 col-xs-4">
				<a class="btn btn-success btn-block w-100" href="?page=amgt-message&tab=compose"><?php esc_html_e('Compose','apartment_mgt');?></a>
			</div>
		...
		<div class="mb-3 row">	
			<div class="col-md-2 col-sm-3 col-xs-12">
				<ul class="list-unstyled mailbox-nav">
					...
					<a href="?page=amgt-message&tab=inbox"><i class="fa fa-inbox"></i> <?php esc_html_e('Inbox','apartment_mgt');?><span class="badge badge-success pull-right"><?php 
					
					echo esc_html(MJ_amgt_count_unread_message_admin(get_current_user_id()));
