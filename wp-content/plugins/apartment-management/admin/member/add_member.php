		...
		<div class="panel-body"><!--PANEL BODY-->
			...
			<div class="form-group">
				...
				<div class="mb-3 row">	
					...
					<div class="col-sm-2">
					 <button type="button" class="btn btn-default remove_unused_model" data-bs-toggle="modal" data-bs-target="#myModal_add_building"> <?php esc_html_e('Add Building','apartment_mgt');?></button>
					</div>
				</div>
			</div>
			<div id="hello"></div>
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label margin_top_10_res_10" for="unit_name"><?php esc_html_e('Member Type','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-sm-3">
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="committee_member"><?php esc_html_e('Committee Member','apartment_mgt');?></label>
					<div class="col-sm-1">
						<div class="col-sm-1">
						<input id="committee_member" class="margin_top_12px form-control text-input" type="checkbox" <?php if($edit==1 && $result->committee_member=='yes'){ echo "checked";}?> name="committee_member" value="yes"></div>	
					</div>	
				...
				<div id="unit_name_entry">
					<div class="form-group">
							<div class="mb-3 row">	
								...
								<label class="col-sm-3 control-label margin_bottom_10_res" for="unit_entry"><?php esc_html_e('Unit Size','apartment_mgt');?>(
								
								<?php if($unit_measerment_type =='square_meter'){
								echo esc_html_e('square meter','apartment_mgt');
								}
								else{
									echo esc_html($unit_measerment_type);
								}
