<?php 
/* AJAX FUNCTION*/
add_action( 'wp_ajax_MJ_amgt_add_or_remove_category', 'MJ_amgt_add_or_remove_category');
add_action( 'wp_ajax_nopriv_MJ_amgt_add_or_remove_category', 'MJ_amgt_add_or_remove_category');
add_action( 'wp_ajax_MJ_amgt_add_or_remove_category_new', 'MJ_amgt_add_or_remove_category_new');
add_action( 'wp_ajax_nopriv_MJ_amgt_add_or_remove_category_new', 'MJ_amgt_add_or_remove_category_new');
add_action( 'wp_ajax_MJ_amgt_add_category', 'MJ_amgt_add_category');
add_action( 'wp_ajax_MJ_amgt_remove_category', 'MJ_amgt_remove_category');
add_action( 'wp_ajax_MJ_amgt_load_unit_cat', 'MJ_amgt_load_unit_cat');
add_action( 'wp_ajax_nopriv_MJ_amgt_load_unit_cat', 'MJ_amgt_load_unit_cat');
add_action( 'wp_ajax_MJ_amgt_load_units', 'MJ_amgt_load_units');
add_action( 'wp_ajax_nopriv_MJ_amgt_load_units', 'MJ_amgt_load_units');
add_action( 'wp_ajax_MJ_amgt_delete_gate', 'MJ_amgt_delete_gate');
add_action( 'wp_ajax_MJ_amgt_load_staff_checkin_data', 'MJ_amgt_load_staff_checkin_data');
add_action( 'wp_ajax_MJ_amgt_load_staff_select_option', 'MJ_amgt_load_staff_select_option');
add_action( 'wp_ajax_MJ_amgt_view_unit', 'MJ_amgt_view_unit');
add_action( 'wp_ajax_MJ_amgt_add_unitname', 'MJ_amgt_add_unitname');
add_action( 'wp_ajax_MJ_amgt_delete_units', 'MJ_amgt_delete_units');
add_action( 'wp_ajax_MJ_amgt_view_event',  'MJ_amgt_view_event');
add_action( 'wp_ajax_MJ_amgt_view_notice',  'MJ_amgt_view_notice');
add_action( 'wp_ajax_nopriv_MJ_amgt_view_notice', 'MJ_amgt_view_notice');
add_action( 'wp_ajax_MJ_amgt_facility_booking_period',  'MJ_amgt_facility_booking_period');
add_action( 'wp_ajax_nopriv_MJ_amgt_facility_booking_period',  'MJ_amgt_facility_booking_period');
add_action( 'wp_ajax_MJ_amgt_count_facility_charge',  'MJ_amgt_count_facility_charge');
add_action( 'wp_ajax_MJ_amgt_load_period',  'MJ_amgt_load_period');
add_action( 'wp_ajax_MJ_amgt_generate_invoice_form',  'MJ_amgt_generate_invoice_form');
add_action( 'wp_ajax_MJ_amgt_unit_member_view',  'MJ_amgt_unit_member_view');
add_action( 'wp_ajax_MJ_amgt_unit_member_history_view',  'MJ_amgt_unit_member_history_view');
add_action( 'wp_ajax_MJ_amgt_unit_document_view',  'MJ_amgt_unit_document_view');
add_action( 'wp_ajax_MJ_amgt_remove_unit_member',  'MJ_amgt_remove_unit_member');
add_action( 'wp_ajax_MJ_amgt_remove_allready_occupied_member',  'MJ_amgt_remove_allready_occupied_member');
add_action( 'wp_ajax_MJ_amgt_load_member_designation',  'MJ_amgt_load_member_designation');
add_action( 'wp_ajax_MJ_amgt_view_complaint',  'MJ_amgt_view_complaint');
add_action( 'wp_ajax_MJ_amgt_service_complaint',  'MJ_amgt_service_complaint');
add_action( 'wp_ajax_MJ_amgt_checkout_popup','MJ_amgt_checkout_popup');
add_action( 'wp_ajax_nopriv_MJ_amgt_checkout_popup','MJ_amgt_checkout_popup');
add_action( 'wp_ajax_MJ_amgt_load_invoice_amount',  'MJ_amgt_load_invoice_amount');
add_action( 'wp_ajax_MJ_amgt_invoice_view',  'MJ_amgt_invoice_view');
add_action( 'wp_ajax_MJ_amgt_member_add_payment',  'MJ_amgt_member_add_payment');
add_action( 'wp_ajax_MJ_amgt_verify_pkey', 'MJ_amgt_verify_pkey');
add_action( 'wp_ajax_nopriv_MJ_amgt_load_unit_measurements','MJ_amgt_load_unit_measurements');
add_action( 'wp_ajax_MJ_amgt_load_unit_measurements','MJ_amgt_load_unit_measurements');
add_action( 'wp_ajax_MJ_amgt_load_tax_amount','MJ_amgt_load_tax_amount');
add_action( 'wp_ajax_MJ_amgt_unit_wise_view_member','MJ_amgt_unit_wise_view_member');
add_action( 'wp_ajax_MJ_amgt_account_unit_wise_view_member','MJ_amgt_account_unit_wise_view_member');
add_action( 'wp_ajax_MJ_amgt_add_unit_popup','MJ_amgt_add_unit_popup');
add_action( 'wp_ajax_MJ_amgt_add_member_popup','MJ_amgt_add_member_popup');
add_action( 'wp_ajax_MJ_amgt_load_document_html','MJ_amgt_load_document_html');
add_action( 'wp_ajax_MJ_amgt_load_document_html_frontend','MJ_amgt_load_document_html_frontend');
add_action( 'wp_ajax_MJ_amgt_generate_invoice_form_allmember','MJ_amgt_generate_invoice_form_allmember');
add_action( 'wp_ajax_MJ_amgt_member_wise_view_invoice','MJ_amgt_member_wise_view_invoice');
add_action( 'wp_ajax_MJ_amgt_invoice_option_html','MJ_amgt_invoice_option_html');
add_action( 'wp_ajax_MJ_amgt_invoice_option_maintance','MJ_amgt_invoice_option_maintance');
add_action( 'wp_ajax_MJ_amgt_unit_allready_occupied','MJ_amgt_unit_allready_occupied');
add_action( 'wp_ajax_MJ_amgt_charge_cal_option_html','MJ_amgt_charge_cal_option_html');
add_action( 'wp_ajax_MJ_amgt_tax_div_html','MJ_amgt_tax_div_html');
add_action( 'wp_ajax_MJ_amgt_change_profile_photo', 'MJ_amgt_change_profile_photo');
add_action( 'wp_ajax_MJ_amgt_load_visitor_data_by_id', 'MJ_amgt_load_visitor_data_by_id');
add_action( 'wp_ajax_nopriv_MJ_amgt_load_visitor_data_by_id', 'MJ_amgt_load_visitor_data_by_id');
add_action( 'wp_ajax_MJ_amgt_load_document_html_member','MJ_amgt_load_document_html_member');
add_action( 'wp_ajax_nopriv_MJ_amgt_load_document_html_member','MJ_amgt_load_document_html_member');
add_action( 'wp_ajax_MJ_amgt_import_data',  'MJ_amgt_import_data');

// CHANGE PROFILE PHOTO
function MJ_amgt_change_profile_photo()
{
	...
	{ 
		...
		{
			//alert('jpg,jpeg,png File allowed');
	...
	<div class="modal-header model_header_border display_block"><!--MODEL_HEADER_BORDER---> 
	<a href="#" class="close-btn badge badge-success pull-right">X</a>
	</div>
	<form class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
		<div class="form-group"><!--SELECT PROFILE---> 
			<div class="mb-3 row">	
				<label for="inputEmail" class="control-label col-sm-3 form-label"><?php esc_html_e('Select Profile Picture','apartment_mgt');?></label>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 padding_top_8">	
...
//----------------- ALL READY OCCPIED --------------//
function MJ_amgt_unit_allready_occupied()
{
	...
	$form='<div class="modal-header padding_15"> 
		...
		<div class="slimScrollDiv">
			...
			if(!empty($users))
			{
				foreach ($users as $retrieved_data)
				{
					...
					if($userimage=='')
					{
						$form.='<img src='.esc_url(get_option( 'amgt_system_logo' )).' height="50px" width="50px" class="img-circle" />';
					}
					else
					{
						$form.='<img src='.esc_url($userimage).' height="50px" width="50px" class="img-circle"/>';	
					}
				
				$form.='</div>
					<p class="col-sm-6 inbox-item-author">'.MJ_amgt_get_display_name($retrieved_data->ID).' ('.MJ_amgt_get_member_status_label($retrieved_data->member_type).')
					</p>				
...
function MJ_amgt_add_or_remove_category()//AMGT_ADD_OR_REMOVE_CATEGORY
{
	...
	if($model == 'member_category')
	{
	 ...
	 $cat_result = MJ_amgt_get_all_category( $model );	
	...
	<?php
	if($model == 'building_category' || $model == 'unit_category')//BUILDING_CATEGORY
	{
	?>
		<div class="modal-header padding_15"> <!--MODAL-HEADER--->

	  		<h4 id="myLargeModalLabel" class="modal-title"><?php echo esc_html($title);?></h4>
			<a href="#" model="building_unit_category" class="close-btn badge badge-success pull-right">X</a>
	...
	?>
		<div class="modal-header padding_15"> <!--MODAL-HEADER--->
	  		...
	  		<h4 id="myLargeModalLabel" class="modal-title"><?php echo esc_html($title);?></h4>
			<a href="#" model="<?php echo esc_html($model);?>"  class="close-btn badge badge-success pull-right">X</a>
	...
	<div class="panel panel-white"><!---PANEL-WHITE--->
		...
		<form name="category_form" action="" method="post" class="form-horizontal" id="category_form"><!---CATEGORY_FORM----->
	  	 	...
	  	 	<div class="form-group">
				<div class="mb-3 row">
					<label class="col-sm-4 control-label form-label" for="category_name"><?php echo esc_html($label_text);?><span class="require-field">*</span></label>
					...
					<div class="col-sm-4 padding_bottom_10">
						<input type="button" value="<?php echo esc_attr($button_text);?>" name="save_category" class="btn btn-success save_category_width" model="<?php echo esc_attr($model);?>" id="btn-add-cat"/>
					</div>
				</div>
...
function MJ_amgt_add_or_remove_category_new()//AMGT_ADD_OR_REMOVE_CATEGORY
{
	$model = $_REQUEST['model'];
	...
	jQuery(document).ready(function()
	{
		jQuery('#category_form_new').validationEngine({promptPosition : "bottomRight",maxErrorsPerField: 1});
	});
	jQuery('.onlyletter_number_space_validation').keypress(function(e) 
	{     
		var regex = new RegExp("^[0-9a-zA-Z \b]+$");
		...
		<div class="modal-header padding_15"> <!--MODAL-HEADER--->
	  		...
	  		<h4 id="myLargeModalLabel" class="modal-title"><?php echo esc_html($title);?></h4>
			<a href="#" class="close-btn_new badge badge-success pull-right">X</a>
	...
	<div class="panel panel-white"><!---PANEL-WHITE--->
		...
		<form name="category_form" action="" method="post" class="form-horizontal" id="category_form_new"><!---CATEGORY_FORM----->
...
//------------- ADD CATEGORY --------------------//
function MJ_amgt_add_category($data)
{
   ...
   { 
	$id = MJ_amgt_add_categorytype($data);
	$row1 = '<tr id="cat-'.$id.'"><td>'.$_REQUEST['category_name'].'</td><td><a class="line_height_set btn-delete-cat badge badge-delete" href="#" id='.$id.' model="'.$model.'">X</a></td></tr>';
...
//----------- REMOVE  CATEGORY -------------//
function MJ_amgt_remove_category()
{
...
//----------------- LOAD UNIT CAT -------------//
function MJ_amgt_load_unit_cat()
{
...
//--------------- DELETE GATE ----------------//
function MJ_amgt_delete_gate()
{
	$obj_gate=new MJ_amgt_gatekeeper;
	if(isset($_REQUEST['gate_id']))
	$obj_gate->MJ_amgt_delete_gate($_REQUEST['gate_id']);
	die();
}
//---------------- LOAD INVOICE AMOUNT -------------//
function MJ_amgt_load_invoice_amount()
{
	$_REQUEST['invoice_id'];
	$obj_account =new MJ_amgt_Accounts;
	$account_result=$obj_account->MJ_amgt_get_single_invoice($_REQUEST['invoice_id']);
	echo $account_result->amount;
	die();
}
//--------------- LOAD STAFF CHECKIN DATA ---------------//
function MJ_amgt_load_staff_checkin_data()
{
	...
	if(!empty($user)){ ?>
		 ...
		 <div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="name"><?php esc_html_e('Name','apartment_mgt');?></label>
					<div class="col-sm-8">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="gender"><?php esc_html_e('Gender','apartment_mgt');?></label>
				<div class="col-sm-8">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="dob"><?php esc_html_e('DOB','apartment_mgt');?></label>
				<div class="col-sm-8">
					<label class="radio-inline" for="dob"><?php echo esc_html(MJ_amgt_change_dateformat(get_user_meta($user->ID,'birth_date',true))); ?></label>
				</div>
			</div>
		</div>
		<div class="form-group">	
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="mobile"><?php esc_html_e('Mobile','apartment_mgt');?></label>
				<div class="col-sm-8">
					<label class="radio-inline" for="mobile"><?php echo esc_html(get_user_meta($user->ID,'mobile',true)); ?></label>
				</div>
			</div>
		</div>
	<?php }
...
//load staff select option // 
function MJ_amgt_load_staff_select_option(){
	
		    $select_slot = $_REQUEST['sloat_id'];
		    global $wpdb;
			$table_name = $wpdb->prefix. 'amgt_sloats';
			$slot_result = $wpdb->get_row("select * from $table_name where id=".$select_slot);
			$sloat_type = $slot_result->sloat_type;
			echo json_encode($sloat_type);
            die();
}
...
function MJ_amgt_view_unit()
{
	...
	<div class="panel panel-white"><!--PANEL WHITE---->
        <form name="category_form" action="" method="post" class="form-horizontal" id="category_form">
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-sm-4 control-label form-label" for="category_name"><?php echo esc_html__('Enter Unit Name','apartment_mgt');?><span class="require-field">*</span></label>
...
//--------------- ADD UNIT NAME -------------------//
function MJ_amgt_add_unitname()
{
	//echo "success";
	$building_id = $_REQUEST['building_id'];
	$unit_cat_id = $_REQUEST['unit_cat_id'];
	$unit_name = $_REQUEST['unit_name'];
	$obj_unit = new MJ_amgt_ResidentialUnit;
	$units = $obj_unit->MJ_amgt_get_single_cat_units($unit_cat_id);
	
	$data = json_decode($units, true);
	$data[] = array('entry'=>$unit_name );
	
	$update_units =  json_encode($data);
	$unitsupdates = $obj_unit->MJ_amgt_update_unit($building_id,$unit_cat_id,$update_units);
	 echo '<tr>';
	echo '<td>';	
	echo $unit_name.'</td>';
	echo '<td>';	
...
//------ VIEW EVENT ------------//
function MJ_amgt_view_event()
{
	 $obj_notice=new MJ_amgt_NoticeEvents;
	 $eventdata= $obj_notice->MJ_amgt_get_single_event($_REQUEST['evnet_id']);
	 ?>
  ...
  <div class="overlay-content content_width">
    ...
    <div class="task_event_list">
     <div class="form-group modal-header padding_15 notice_popup"> 	
		  
		   <h4 class="modal-title" id="myLargeModalLabel">
		   <?php esc_html_e('Event Detail','apartment_mgt'); ?>
		  </h4>
		  <a href="#" class="complaint-close-btn badge badge-success pull-right">X</a>
			...
			<table id="examlist" class="table table-striped" cellspacing="0" width="100%" align="center">
				<tbody>
					...
					<tr>
						...
						<td><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($eventdata->start_date)));?></td>
					</tr>			
					<tr>
                     ...
                     <tr>
						...
						<td><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($eventdata->end_date)));?></td>
					</tr>
                    <tr>
...
//----------------- VIEW NOTICE -----------------//
function MJ_amgt_view_notice()
{

	 $obj_notice=new MJ_amgt_NoticeEvents;
	 $noticedata= $obj_notice->MJ_amgt_get_single_notice($_REQUEST['notice_id']);
	?>
<!---Notice Pop Up -->
  <div class="overlay-content content_width">
    <div class="modal-content new_css">
			...
			<table id="examlist" class="table table-striped" cellspacing="0" width="100%" align="center">
				<tbody>
					...
					<tr>
						...
						<td> <?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($noticedata->valid_date)));?></td>
					</tr>
					<tr>
					...
					<tr>
						<td  class="popup_font notice_discription_scroll"><?php esc_html_e('Description:', 'apartment_mgt' ) ;?></td>
						<td><?php echo esc_html( $noticedata->description);?></td>
					</tr>	
...
//----------------- VIEW COMPLAINT ----------------//
function MJ_amgt_view_complaint()
{
	$obj_complaint=new MJ_amgt_Complaint;
	$complaintdata= $obj_complaint->MJ_amgt_get_single_complaint($_REQUEST['complaint_id']);
...
<div class="overlay-content content_width">
    ...
    <div class="task_event_list">
     <div class="form-group modal-header padding_15 notice_popup"> 	
		  ...
		  <h4 class="modal-title" id="myLargeModalLabel">
		   <?php esc_html_e('Complaint Details','apartment_mgt'); ?>
		  </h4>
		  <a href="#" class="complaint-close-btn badge badge-success pull-right">X</a>
			...
			<table id="examlist" class="table table-striped" cellspacing="0" width="100%" align="center">
				<tbody>
					<tr>
						...
						<td><?php 
						if($complaintdata->complaint_nature == "complaint")
						{
							echo esc_html_e('Complaint','apartment_mgt' );
						}
						elseif($complaintdata->complaint_nature == "suggestion")
						{
							echo esc_html_e('Suggestion','apartment_mgt');
						}
						elseif($complaintdata->complaint_nature == "request")
						{
							echo esc_html_e('Request','apartment_mgt');
						}
						elseif($complaintdata->complaint_nature == "Maintenance Request")
						{
					...
					<tr>
						...
						<td><?php
						 ...
						 {
							echo esc_html_e('Individual','apartment_mgt');
						 }
						 elseif($complaintdata->complaint_type == 'society')
						 {
							echo esc_html_e('Compound','apartment_mgt');
						 }
					...
					?>
						<tr>
							...
							<td><?php echo esc_html(get_the_title($complaintdata->complaint_cat));?> </td>
						</tr>	
					<?php
					}
					?>
					<tr>
						...
						<td><?php $user=get_userdata($complaintdata->created_by); echo esc_html(ucfirst($user->display_name));?></td>
					</tr>
                     <tr>
						<td class="popup_font"><?php esc_html_e('Status:','apartment_mgt');?></td>
						<td><?php 
...
//Add-service 
function MJ_amgt_service_complaint()
{
	 $obj_service=new MJ_amgt_Service;
	 $service_data= $obj_service->MJ_amgt_get_single_service($_REQUEST['service_id']);
	 ?>
<div class="overlay-content content_width">
    <div class="modal-content new_css">
    <div class="task_event_list">
				...
				<tbody>
					...
					<tr>
                     ...
                     <tr>
						...
						<td><?php echo esc_html(wp_trim_words($service_data->address,5));?></td>
					</tr>					
				</tbody>
			</table>
        </div>  		
...
//Add-service 
function MJ_amgt_checkout_popup()
{   
	 ...
	 $obj_gates=new MJ_amgt_gatekeeper;
	 $exit_gates=$obj_gates->MJ_amgt_get_all_exit_gates();		
?>	
<div class="modal-header padding_15"> 	
...
<div class="panel panel-white form-horizontal">
	<form name="checkout_form" action="" method="post" class="form-horizontal checkout-form">
		...
		<?php $role=MJ_amgt_get_user_role($retrieved_data->ID); 
		if($obj_apartment->role=='administrator') {
		?>
		<?php foreach($exit_gates as $gate){ ?>
		<div class="form-group checkout">		   
			<div class="mb-3 row">
				<div class="col-sm-5 checkout margin_left_13"> <input type="radio" class="tog radio_border_radius" name="gate_name" value="<?php echo esc_attr($gate->id);?>"><label class="padding_top_10_left_5"><?php echo esc_html($gate->gate_name);?></label></div>
			</div>	
		</div>
		<?php }} else { ?>
		...
		<div class="form-group checkout">		   
			<div class="mb-3 row">	
				<div class="col-sm-5 checkout front_radio margin_left_13"> <input type="radio" class="tog radio_border_radius" name="gate_name" value="<?php echo esc_attr($gate->id);?>"><label class="padding_top_10_left_5"><?php echo esc_html($gate->gate_name);?></label></div>
			</div>	
		</div>
		<?php }} ?>
		
		  
		<div class="offset-sm-2 col-lg-8 col-md-8 col-sm-8 col-xs-12 margin_left_0">
...
function MJ_amgt_facility_booking_period()
{ ?>
<script type="text/javascript">
...
.dropdown-menu {
	...
	{
	$result = $obj_facility->MJ_amgt_get_single_facility($_REQUEST['facility_id']);
	...
	<div class="form-group">
		<div class="mb-3 row">
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="end_date">
...
function MJ_amgt_count_facility_charge()
{ 
	$charges=0;
	...
	if(isset($_REQUEST['period_type'])){
		...
		if($_REQUEST['period_type']=='date_type'){
			 ...
			 //count date wise facility chargis function
			  $dStart = new DateTime(MJ_amgt_get_format_for_db($_REQUEST['start']));
			  $date=MJ_amgt_get_format_for_db($_REQUEST['end']);
...
function MJ_amgt_generate_invoice_form()
{ 
$obj_units=new MJ_amgt_ResidentialUnit;
	$invoice_id=0;
			...
			$edit=0;
				if(isset($_REQUEST['action']) && sanitize_text_field($_REQUEST['action']) == 'edit'){
					$edit=1;
					$result = $obj_account->MJ_amgt_get_single_invoice($invoice_id);
				} 
?>
<script type="text/javascript">
$(document).ready(function() {
	...
	$("body").on("change",".select_serveice_invoice",function(){	
...
.overlay-content {
	...
	<div class="modal-header padding_15"> 	
		...
		<a href="#" class="invoice-close-btn badge badge-success pull-right">X</a>
	</div>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="enable"><?php esc_html_e('Invoice Option','hospital_mgt');?></label>
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="income_type">
				...
				<select class="form-control validate[required]" name="income_type" id="income_types">
					...
					$activity_category=MJ_amgt_get_all_category('income_types');
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="title"><?php esc_html_e('Title','apartment_mgt');?><span class="require-field">*</span></label>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="unit_name"><?php esc_html_e('Year','apartment_mgt');?><span class="require-field">*</span></label>
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="to_date">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="invoice_date">
...
//----------------------- UNIT MEMBER VIEW ----------------//
function MJ_amgt_unit_member_view()
{
	$unit_name = $_REQUEST['unit_name'];
	$building_id = $_REQUEST['building_id'];
	...
	<div class="modal-header padding_15"> 	
		<h4 class="modal-title" id="myLargeModalLabel">
			<?php esc_html_e('Member Detail','apartment_mgt');?>
		</h4>
		<a href="#" class="close-btn badge badge-success pull-right">X</a>
	</div>
	<hr>
	<div class="panel-body">
		<div class="slimScrollDiv 123">
			<div class="inbox-widget slimscroll">
			<?php 
			if(!empty($allmembers))
			...
			{
			?>
				<div class="inbox-item row" id="cat-<?php echo $retrieved_data->ID;?>">
					<div class="inbox-item-img">
			<?php 
				$uid=$retrieved_data->ID;
				$userimage=get_user_meta($uid, 'amgt_user_avatar', true);
			...
			?>
				...
				<label  class="margin_left_50"><?php echo esc_html(MJ_amgt_get_display_name($retrieved_data->ID)); ?></label>				
				</p>
				<p class="col-sm-3 inbox-item-author txt_color_frontend">			
				<span class="txt_color txt_color_frontend">(<?php echo esc_html(MJ_amgt_get_member_status_label($member_type));?>)</span> 
				</p>
				<?php if (is_super_admin ())
					{?>
				        <div class="col-sm-3"><a href="?page=amgt-member&tab=viewmember&action=view&member_id=<?php echo esc_attr($retrieved_data->ID);?>"  class="btn btn-default"><i class="fa fa-eye"></i><?php esc_html_e('View Details','apartment_mgt');?></a></div>
						<p class="col-sm-2"><button id="delete_unitmember" class="btn btn-danger margin_top_10_res delete_group_member"  mem_id="<?php echo esc_attr($retrieved_data->ID);?>" type="button">
						<i class="fa fa-trash"></i> <?php esc_html_e('Delete','apartment_mgt');?></button></p>
			  <?php } 
			  else
			  { ?>
				<div class="col-sm-3"><a href="?apartment-dashboard=user&page=member&tab=viewmember&action=view&member_id=<?php echo esc_attr($retrieved_data->ID);?>"  class="btn btn-default"><i class="fa fa-eye view_eye"></i><?php esc_html_e('View Details','apartment_mgt');?></a></div>  
			 <?php  } ?>
				</div>
			...
			{
				?>
			<p><?php esc_html_e('No history Available','apartment_mgt');?></p>
			<?php
			} 
			?>
			</div>
...
function MJ_amgt_unit_member_history_view()
{
	global $wpdb;
	$unit_name = $_REQUEST['unit_name'];	
	$building_id = $_REQUEST['building_id'];	
	...
	<div class="modal-header padding_15"> 	
		<h4 class="modal-title" id="myLargeModalLabel">
			<?php esc_html_e('Member history','apartment_mgt');?>
		</h4>
		<a href="#" class="close-btn badge badge-success pull-right">X</a>
	</div>
	<hr>
			...
			<div class="inbox-widget slimscroll">	
				...
				<table class="table table-bordered border_colleps" width="100%" border="1">
						...
						{	
							...
							?>
									<tr>
										<td class="text-center"><?php echo esc_html(get_the_title($retrieved_data->building_id));?></td>
										...
										<td class="text-center"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($retrieved_data->occupied_from_date)));?></td>
										<td class="text-center"><?php if(!empty($retrieved_data->occupied_to_date)){echo esc_html(date(MJ_amgt_date_formate(),strtotime($retrieved_data->occupied_to_date)));}?></td>
									</tr>
							<?php
							}
						}
...
//--------------- UNIT DOCUMENT VIEW ------------------//
function MJ_amgt_unit_document_view()
{
	$curr_user_id=get_current_user_id();
	$obj_apartment=new MJ_amgt_Apartment_management($curr_user_id);
	...
	$unit_name = $_REQUEST['unit_name'];	
	$building_id = $_REQUEST['building_id'];	
	$alldocuments = $obj_doc->MJ_amgt_get_units_all_documents_new($_REQUEST['unit_name'],$_REQUEST['building_id']);
				...
				<?php foreach ($alldocuments as $retrieved_data)
				{
					...
					?>
						<tr>			
							...
							<td class="view_document_eye"><a target="_blank" href="<?php echo esc_url($retrieved_data->document_content); ?>"><button class="btn btn-default margin_top_5" type="button">
...
//----------------- REMOVE UNIT MEMBER -------------------//
function MJ_amgt_remove_unit_member()
{
...
function MJ_amgt_remove_allready_occupied_member()
{
	$user_id=$_REQUEST['member_id'];
...
function MJ_amgt_load_member_designation()
{
	$status=$_REQUEST['check_status'];
	if($status=='checked')
	{  ?>
		
			<div class="col-sm-6 px-2 margin_top_10_res">
			...
			<div class="col-sm-3"><button class="btn btn-default margin_top_10_res" id="addremove" model="designation_cat"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button></div>
...
function MJ_amgt_invoice_view()
{
	$obj_payment= new MJ_amgt_Accounts();
	$obj_tax =new MJ_amgt_Tax;
	if($_REQUEST['invoice_type']=='invoice')
	{	

		$invoice_data=$obj_payment->MJ_amgt_get_single_invoice_by_id($_REQUEST['idtest']);	
		$old_invoice_id=$invoice_data->invoice_id;
		if(isset($old_invoice_id))
		{
		  $invoice_old_data=$obj_payment->MJ_amgt_get_single_old_invoice_by_id($old_invoice_id);
	...
	{
		$expense_data=$obj_payment->MJ_amgt_get_single_expense($_POST['idtest']);
	}
	?>	
	<style>
	.color_white  {
	...
	<div class="modal-header padding_15">
		<a href="#" class="bill-close-btn badge badge-success pull-right ms-auto">X</a>		
	</div>
	<div class="modal-body invoice_body">
		<div id="invoice_print">
			...
			{
				?>
			 <img class="invoicefont1"  src="<?php echo plugins_url('/apartment-management/assets/images/invoice-rtl.jpg'); ?>" >
			<?php			 
			}
			else{
				?>
			...
			<div class="main_div">					
				<table class="width_100" border="0">					
					<tbody>
						<tr>
							<td class="width_1">
								<img class="system_logo"  src="<?php echo esc_url(get_option( 'amgt_system_logo' )); ?>">
							</td>							
				...
				<table class="width_50 float_left_invoice_rtl" border="0">
					<tbody>				
						<tr>
							...
							<?php 
								...
								else
								{
									...
									echo get_the_title(get_user_meta($member_id,'building_id',true)).",";
									echo get_user_meta($member_id,'unit_name',true)."<br>";
					...
					if(!empty($invoice_data))
					{
						$issue_date=date(MJ_amgt_date_formate(),strtotime($invoice_data->created_date));						
						$payment_status=$invoice_data->payment_status;
						$invoice_no=$invoice_data->invoice_no;
					}					
					if(!empty($expense_data))
					{						
						$issue_date=date(MJ_amgt_date_formate(),strtotime($expense_data->payment_date));						
						$payment_status="Paid";						
					}	
					
					?>
				<table class="width_50 float_left_invoice_tble_50" border="0">
					<tbody>				
						<tr>	
							<td class="width_30">
							</td>
							<td class="width_20" align="left">
								...
								<h5><?php echo esc_html__('Status','apartment_mgt')." : ". esc_html__($payment_status,'apartment_mgt'); 
								 ?>
								</h5>
									<?php
									if(!empty($invoice_data->charges_id))
									{ 
										$charge_period=MJ_amgt_get_charge_period_by_id($invoice_data->charges_id);
									}
									if($_POST['invoice_type']=='invoice')
									{
									   $invoice_length=strlen($invoice_data->invoice_no);
										...
										{ 
											...
											{
											?>
												<h4><?php esc_html_e('Billing Period','apartment_mgt');?></h4><br>
												<h5><?php echo esc_html__('From','apartment_mgt')." : ". __(date(MJ_amgt_date_formate(),strtotime($invoice_data->start_date)),'apartment_mgt');?></h5>				
												<h5><?php echo esc_html__('To','apartment_mgt')." : ". __(date(MJ_amgt_date_formate(),strtotime($invoice_data->end_date)),'apartment_mgt');?></h5>				
											<?php		
											}
										}
									}
				...
				<table class="table table-bordered" class="width_93" border="1">
					<thead class="entry_heading">					
							<tr>
								...
								if(!empty($invoice_data->charges_id))
								{
									$charge_cal_by=MJ_amgt_get_invoice_charges_calculate_by($invoice_data->charges_id);
								}
					...
					<?php
								...
								{									
								 ?>
									<tr class="entry_list">
										...
										<td class="align_center"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($invoice_data->created_date)));?></td>
										<td><?php echo esc_html($entry->entry);?></td>
										<td class="align_right"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($entry->amount)); ?></td>
									</tr>
								<?php
							...
							{	
								if($invoice_length == '9')
								{
									...
									<tr class="entry_list">
										...
										<td class="align_right"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($invoice_data->invoice_amount)); ?></td>
									</tr>
									<?php
								}
								else	
								{
									$charge_cal_by=MJ_amgt_get_invoice_charges_calculate_by($invoice_id);
									...
									?>
										<tr class="entry_list">
											...
											<?php									
											$measurement=MJ_amgt_get_single_member_unit_size($member_id);
											$charge=MJ_amgt_get_single_member_measurment_charge($invoice_data->charges_id);
											?>
											<td><?php echo esc_html($measurement);?></td>
											<td><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.$charge);?></td>
											<?php
											$amount=$invoice_data->amount+$invoice_data->discount_amount;
											?>
											<td class="align_right"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($amount)); ?></td>
										</tr>
									<?php							
									}
								}	
						...
						?>
							<tr class="entry_list">
								<td class="align_center"><?php echo esc_html($id);?></td>
								<td class="align_center"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($expense_data->payment_date)));?></td>
								<td><?php echo esc_html(get_the_title($expense_data->type_id)); ?> </td>
								<td class="align_right"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($expense_data->amount)); ?></td>								
							</tr>
					  <?php 
						} 
						?>						
				...
				<table class="width_54" border="0">
					<tbody>
						...
						{								
							...
							{		
								...
								else
								{
									...
									$discount=$invoice_data->discount_amount;
									$subtotal_amount=(int)$after_sub_discount_amount+(int)$discount;
						...
						<tr>
							...
							<td class="align_right"> <h4 class="margin margin_right_14"><span><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php echo esc_html(round($subtotal_amount));?></h4></td>
						</tr>
						<?php
						if($_POST['invoice_type']!='expense')
						{							
							...
							<tr>
								...
								<td class="align_right"> <h4 class="margin margin_right_14"><span ><?php  echo "-";echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php if(!empty($discount)){ echo esc_html(round($discount)); }else{ echo '0'; } ?></h4></td>
							</tr>
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Tax Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"><h4 class="margin margin_right_14"> <span ><?php  echo "+";echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php if(!empty($tax_amount)){ echo esc_html(round($tax_amount)); }else{ echo '0'; }?></h4></td>
							</tr>							
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Due Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"> <h4 class="margin margin_right_14"><span ><?php  echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php echo esc_html(round(abs($due_amount))); ?></h4></td>
							</tr>
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Paid Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"> <h4 class="margin margin_right_14"><span ><?php  echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php if(!empty($paid_amount)){ echo esc_html(round($paid_amount)); }else{ echo '0'; }?></h4></td>
							</tr>
						<?php
						}
						?>
						<tr>							
							...
							<td class="align_right grand_total_amount"><h3 class="color_white margin">  <span><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?>  <?php echo esc_html(round($grand_total)); ?> </span></h3></td>
						</tr>							
					</tbody>
				</table>
				<?php
					...
					<table class="width_46" border="0">
						<tbody>						
							...
							<tr>
								...
								<td class="font_12">: <?php echo esc_html(get_option( 'apartment_paypal_email' ));?></td>
							</tr>				
						</tbody>
					</table>
					<?php
		...
		<div class="print-button pull-left">
			<a  href="?page=invoice&print=print&invoice_id=<?php echo esc_attr($_REQUEST['idtest']);?>&invoice_type=<?php echo esc_attr($_POST['invoice_type']);?>" target="_blank"class="btn btn-success"><?php esc_html_e('Print','apartment_mgt');?></a>
			<?php
			if($_POST['invoice_type']!='expense')
			{
			?>	
				<a href="?page=invoinvoiceice&invoicepdf=invoicepdf&invoice_id=<?php echo esc_attr($_REQUEST['idtest']);?>&invoice_type=<?php echo esc_attr($_POST['invoice_type']);?>" target="_blank" class="btn btn-success"><?php esc_html_e('PDF','apartment_mgt');?></a>
			<?php
			}
			?>
		</div>
...
//---------------- INVOICE PRINT ----------------//
function MJ_amgt_invoice_print($id,$type)
{
	$obj_payment= new MJ_amgt_Accounts();
	$obj_tax =new MJ_amgt_Tax;
	if($type=='invoice')
	{		
		$invoice_data=$obj_payment->MJ_amgt_get_single_invoice_by_id($id);
		if(isset($old_invoice_id))
		{
        $old_invoice_id=$invoice_data->invoice_id;
		$invoice_old_data=$obj_payment->MJ_amgt_get_single_old_invoice_by_id($old_invoice_id);
	...
	if($type=='expense')
	{
		$expense_data=$obj_payment->MJ_amgt_get_single_expense($id);
	}
	  echo '<link rel="stylesheet" href="'.plugins_url( '/assets/css/style.css', __FILE__).'"></link>';
	  if (is_rtl())
		{
			 echo '<link rel="stylesheet" href="'.plugins_url( '/assets/css/bootstrap/custom-rtl.css', __FILE__).'"></link>';
			...
			<div class="main_div">					
				<table class="width_100" border="0">					
					<tbody>
						<tr>
							<td class="width_1">
								<img class="system_logo_print"  src="<?php echo esc_url(get_option( 'amgt_system_logo' )); ?>">
							</td>							
							<td class="only_width_20">
								<?php
				...
				<table class="table table-bordered width_100 table_new" class="width_93" border="1">
					...
					<?php
								...
								{									
								 ?>
									<tr class="entry_list">
										...
										<td class="align_center padding_color_black"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($invoice_data->created_date)));?></td>
										<td class="padding_color_black"><?php echo esc_html($entry->entry);?></td>
										<td class="align_right padding_color_black"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($entry->amount)); ?></td>
									</tr>
								<?php
								$entry_total_amount+=$entry->amount;
								$id=$id+1;
							...
							else	
							{
								if($invoice_length == '9')
								{
									...
									<tr class="entry_list">
										...
										<td class="align_right padding_color_black"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($invoice_data->invoice_amount)); ?></td>
									</tr>
									<?php
								}
								else	
								{
									...
									?>
										<tr class="entry_list">
											...
											<td class="padding_color_black"><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.$charge);?></td>
											<?php
											$amount=$invoice_data->amount+$invoice_data->discount_amount;
											?>
											<td class="align_right padding_color_black"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($amount)); ?></td>
										</tr>
									<?php							
									}
								}		
						...
						?>
							<tr class="entry_list">
								<td class="align_center padding_color_black"><?php echo esc_html($id);?></td>
								<td class="align_center padding_color_black"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($expense_data->payment_date)));?></td>
								<td class="padding_color_black"><?php echo esc_html(get_the_title($expense_data->type_id)); ?> </td>
								<td class="align_right padding_color_black"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($expense_data->amount)); ?></td>								
							</tr>
					  <?php 
						} 
						?>						
				...
				<table class="width_54" border="0">
					<tbody>
						...
						<tr>
							...
							<td class="align_right"> <h4 class="margin"><span><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php echo esc_html(round($subtotal_amount));?></h4></td>
						</tr>
						<?php
						if($type!='expense')
						{							
							...
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Discount Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"> <h4 class="margin"><span ><?php  echo "-";echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php if(!empty($discount)){ echo esc_html(round($discount)); }else{ echo '0'; } ?></h4></td>
							</tr>
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Tax Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"><h4 class="margin"> <span ><?php  echo "+";echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php if(!empty($tax_amount)){ echo esc_html(round($tax_amount)); }else{ echo '0'; }?></h4></td>
							</tr>							
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Due Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"> <h4 class="margin"><span ><?php  echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php echo esc_html(round(abs($due_amount))); ?></h4></td>
							</tr>
							<tr>
								<td class="width_70 align_right"><h4 class="margin"><?php esc_html_e('Paid Amount :','apartment_mgt');?></h4></td>
								<td class="align_right"> <h4 class="margin"><span ><?php  echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span><?php if(!empty($paid_amount)){ echo esc_html(round($paid_amount)); }else{ echo '0'; }?></h4></td>
							</tr>
						<?php
						}
						?>
						<tr>							
							...
							<td class="align_right grand_total_amount1"><h3 class="color_white margin">  <span><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?>  <?php echo esc_html(round($grand_total)); ?> </span></h3></td>
						</tr>							
					</tbody>
				</table>
				<?php
...
function MJ_amgt_invoice_payment_receipt_print($invoice_id,$member_id)
{
	$obj_tax =new MJ_amgt_Tax;
	$obj_payment= new MJ_amgt_Accounts();
	$invoice_data=$obj_payment->MJ_amgt_get_single_invoice_by_id($invoice_id);
	$payment_data=$obj_payment->MJ_amgt_invoice_payment_by_member($invoice_id,$member_id);
	echo '<link rel="stylesheet" href="'.plugins_url( '/assets/css/style.css', __FILE__).'"></link>';
	if (is_rtl())
		{
			 echo '<link rel="stylesheet" href="'.plugins_url( '/assets/css/bootstrap/custom-rtl.css', __FILE__).'"></link>';
		...
		<div id="invoice_print1">
			...
			<div class="main_div">					
				...
				<table class="table table-bordered width_100 table_new" class="width_93" border="1">
					<thead class="entry_heading">					
							<tr>
								<th class=" align_center padding_color width_2"><span class="">#</span></th>
								<th class=" align_center padding_color width_13"> <span class=""><?php esc_html_e('Date','apartment_mgt');?></span></th>
								<th class=" align_center padding_color width_18"><span class=""><?php esc_html_e('Charge Type','apartment_mgt');?></span> </th>
								<th class=" align_center padding_color width_20"><span class=""><?php esc_html_e('Payment Method','apartment_mgt');?></span></th>
								<th class=" align_right padding_color width_17"><span class=""><?php esc_html_e('Paid Amount','apartment_mgt');?></span></th>	
								<th class=" align_center padding_color width_25"><span class=""><?php esc_html_e('Notes','apartment_mgt');?></span> </th>													
							</tr>						
					</thead>
					<tbody>
						<?php 
						...
						if(!empty($payment_data))
						{
							...
							<tr>
								...
								<td class="align_center padding_color_black"><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($data->date)));?></td>	
								<td class="align_center padding_color_black"><?php echo esc_html_e($charge_type);?></td>
					             <td class="align_center padding_color_black">
								 <?php 
					             ...
					             {
					             	esc_html_e('Stripe','apartment_mgt');
					             }
								 elseif ($data->payment_method == "Instamojo") 
					             {
					             	esc_html_e('Instamojo','apartment_mgt');
					             }
								elseif ($data->payment_method == "PayUMony") 
					             {
					             	esc_html_e('PayUMony','apartment_mgt');
					             }
								elseif ($data->payment_method == "2CheckOut") 
					             {
					             	esc_html_e('2CheckOut','apartment_mgt');
					             }
								 elseif ($data->payment_method == "Skrill") 
					             {
					             	esc_html_e('Skrill','apartment_mgt');
					             }
								 elseif ($data->payment_method == "Paystack") 
					             {
					             	esc_html_e('Paystack','apartment_mgt');
					             }
								 elseif ($data->payment_method == "Paytm") 
					             {
					             	esc_html_e('Paytm','apartment_mgt');
					             }
								 elseif ($data->payment_method == "razorpay") 
					             {
					             	esc_html_e('Razorpay','apartment_mgt');
					             }
								 elseif ($data->payment_method == "paypal") 
					             {
					             	esc_html_e('Paypal','apartment_mgt');
					             }
					            ?></td>
					         
							    <td class="align_center padding_color_black"> <?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($data->amount)); ?></td>
				...
				<table class="width_40_right margin_total_paid_amount" border="0">
						<tbody>												
							<tr>
								...
								<td class="width_20_reciept color margin_right_14"><h4 class="total_paid_amount align_right"><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).' '.round($total_paid_amount)); ?></h4></td>
							</tr>
						</tbody>
					</table>				
			</div>
...
// invoice pdf
function MJ_amgt_invoice_pdf($id,$type)
{
	//error_reporting(0);
	$obj_payment= new MJ_amgt_Accounts();	
   ...
   echo '<link rel="stylesheet" href="'.plugins_url( '/assets/css/bootstrap/bootstrap.min.css', __FILE__).'"></link>';
  
  echo '<script  rel="javascript" src="'.plugins_url( '/assets/js/bootstrap/bootstrap.min.js', __FILE__).'"></script>'; 
...
$mpdf->autoLangToFont = true;
	...
	$mpdf->WriteHTML('</head>');
		...
		if (is_rtl())
		{
		 $mpdf->WriteHTML('<body style="direction: rtl;">');			 	
		}
		else{
			$mpdf->WriteHTML('<body>');
		}	
	...
	$mpdf->WriteHTML('<div id="invoice_print">');
			...
			if (is_rtl())
			{
				$mpdf->WriteHTML('<img class="invoicefont1"  src="'.plugins_url('/apartment-management/assets/images/invoice-rtl.jpg').'" style="width:auto;transform: scale(-1,1);float:left;max-width: 300px;">');		 
			}
			else{
					...
					$mpdf->WriteHTML('<tbody>');
						$mpdf->WriteHTML('<tr>');
							$mpdf->WriteHTML('<td class="width_1_print">');
								$mpdf->WriteHTML('<img class="system_logo"  src="'.esc_url(get_option( 'amgt_system_logo' )).'">');
							$mpdf->WriteHTML('</td>');							
						...
						$mpdf->WriteHTML('<tr>');	
							...
							if($type=='invoice')
							{
								...
								{ 
									if($charge_period==0)
									{	
										$mpdf->WriteHTML('&nbsp;<h5>'.esc_html__('Billing Period','apartment_mgt').'</h5>&nbsp;'); 
										$mpdf->WriteHTML('<h5>'.esc_html__('From (','apartment_mgt').''.date(MJ_amgt_date_formate(),strtotime($invoice_data->start_date)).') &nbsp;'.esc_html__('To (','apartment_mgt').' '.date(MJ_amgt_date_formate(),strtotime($invoice_data->end_date)).' )</h5>');	
									}
								}	
							}								
							$mpdf->WriteHTML('</td>');							
							...
							if(empty($invoice_data->invoice_no))
							{
								...
								foreach($all_entry as $entry)
								{
									 $mpdf->WriteHTML('<tr class="entry_list">');
										...
										$mpdf->WriteHTML('<td class="align_center padding_color_black">'.date(MJ_amgt_date_formate(),strtotime($invoice_data->created_date)).'</td>');
										$mpdf->WriteHTML('<td class="padding_color_black">'.$entry->entry.'</td>');
										$mpdf->WriteHTML('<td class="align_right padding_color_black"><span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($entry->amount).'</td>');
									$mpdf->WriteHTML('</tr>');								
									$entry_total_amount+=$entry->amount;
									$id=$id+1;
								}
							...
							else	
							{
								...
								{						
									...
									$mpdf->WriteHTML('<tr class="entry_list">');
										...
										$mpdf->WriteHTML('<td class="align_right padding_color_black"><span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($invoice_data->invoice_amount).'</td>');
									$mpdf->WriteHTML('</tr>');
								...
								else	
								{
									...
									else
									{
										...
										$mpdf->WriteHTML('<tr class="entry_list">');
											...
											$mpdf->WriteHTML('<td class="padding_color_black">'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).''.$charge.'</td>');
											
											$amount=$invoice_data->amount+$invoice_data->discount_amount;
											
											$mpdf->WriteHTML('<td class="align_right padding_color_black"><span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($amount).'</td>');
										$mpdf->WriteHTML('</tr>');
				 ...
				 $mpdf->WriteHTML('<td>');
					...
					$mpdf->WriteHTML('<tbody>');
							...
							$mpdf->WriteHTML('<tr>');
								...
								$mpdf->WriteHTML('<td class="align_right"> <h4 class="margin"><span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($subtotal_amount).'</h4></td>');
							$mpdf->WriteHTML('</tr>');	
							if(!empty($discount))
							{	
								$discount=$discount;
							...
							$mpdf->WriteHTML('<tr>');
								...
								$mpdf->WriteHTML('<td class="align_right"> <h4 class="margin"><span >-'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($discount).'</h4></td>');
							$mpdf->WriteHTML('</tr>');
							if(!empty($tax_amount))
							{	
							...
							$mpdf->WriteHTML('<tr>');
								...
								$mpdf->WriteHTML('<td class="align_right"><h4 class="margin"> <span >+'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($tax_amount).'</h4></td>');
							$mpdf->WriteHTML('</tr>');	
							
							$mpdf->WriteHTML('<tr>');
								$mpdf->WriteHTML('<td class="width_70 align_right"><h4 class="margin">'.esc_html__('Due Amount :','apartment_mgt').'</h4></td>');
								$mpdf->WriteHTML('<td class="align_right"> <h4 class="margin"><span >'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round(abs($due_amount)).'</h4></td>');
							$mpdf->WriteHTML('</tr>');
							...
							$mpdf->WriteHTML('<tr>');
								...
								$mpdf->WriteHTML('<td class="align_right"> <h4 class="margin"><span >'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($paid_amount).'</h4></td>');
							$mpdf->WriteHTML('</tr>');					
						$mpdf->WriteHTML('<tr>');							
							...
							$mpdf->WriteHTML('<td class="align_right grand_total_amount padding_10"><h3 class="color_white margin">  <span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($grand_total).'</h3></td>');
						$mpdf->WriteHTML('</tr>');							
					$mpdf->WriteHTML('</tbody>');
					$mpdf->WriteHTML('</table>');
...
function MJ_amgt_send_invoice_generate_mail($emails,$subject,$message,$invoiceid)
{	
	//error_reporting(0);
	...
	$address="";
	$type="";
	$invoice_data=$obj_payment->MJ_amgt_get_single_invoice_by_id($invoiceid);
	$history_detail_result=$obj_payment->MJ_amgt_get_single_invoice_payment_history_by_id($invoiceid);
	require_once AMS_PLUGIN_DIR . '/lib/mpdf/vendor/autoload.php';
	$mpdf = new \Mpdf\Mpdf;
	...
	$stylesheet = file_get_contents(AMS_PLUGIN_DIR. '/assets/css/style.css'); // Get css content
	$stylesheet_1 = file_get_contents(AMS_PLUGIN_DIR. '/assets/css/bootstrap/bootstrap.min.css'); // Get css content
	$stylesheet_2 = file_get_contents(AMS_PLUGIN_DIR. '/assets/js/bootstrap/bootstrap.min.js'); // Get css content

	$mpdf->WriteHTML('<html>');
	$mpdf->WriteHTML('<head>');
	$mpdf->WriteHTML('<style></style>');
	$mpdf->WriteHTML($stylesheet,1); // Writing style to pdf
	$mpdf->WriteHTML($stylesheet_1,1); // Writing style to pdf
	$mpdf->WriteHTML($stylesheet_2,1); // Writing style to pdf
	$mpdf->WriteHTML('</head>');
	$mpdf->WriteHTML('<body>');		
	$mpdf->SetTitle('Invoice');
		$mpdf->WriteHTML('<div');				
					...
					$mpdf->WriteHTML('<tbody>');				
						...
						$mpdf->WriteHTML('<tr>');	
							...
							$mpdf->WriteHTML('<td class="width_20_print padding_right_30" align="left">');
								$mpdf->WriteHTML('<h5>'.esc_html__('Date','apartment_mgt').':'.$issue_date.'</h5><br>');
								$mpdf->WriteHTML('<h5>'.esc_html__('Status','apartment_mgt').':'.esc_html__(''.$payment_status.'','apartment_mgt').'</h5>');									
							$mpdf->WriteHTML('</td>');							
						$mpdf->WriteHTML('</tr>');	
						...
						$mpdf->WriteHTML('<tr>');	
							...
							if($type=='invoice')
							{
								if($charge_period==0)
								{	
									$mpdf->WriteHTML('<h5>'.esc_html__('Billing Period','apartment_mgt').'</h5><br>');
									$mpdf->WriteHTML('<h5>'.esc_html__('From (','apartment_mgt').''.date(MJ_amgt_date_formate(),strtotime($invoice_data->start_date)).') <br>'.esc_html__('To (','apartment_mgt').' '.date(MJ_amgt_date_formate(),strtotime($invoice_data->end_date)).' )</h5>');	
								}
							}								
							$mpdf->WriteHTML('</td>');							
						$mpdf->WriteHTML('</tr>');												
						...
						{	
							...
							if($charge_cal_by->charges_calculate_by=='fix_charge')
							{
								...
								foreach($all_entry as $entry)
								{
									$mpdf->WriteHTML('<tr class="entry_list">');
										...
										$mpdf->WriteHTML('<td class="align_center">'.date(MJ_amgt_date_formate(),strtotime($invoice_data->created_date)).'</td>');
										$mpdf->WriteHTML('<td>'.$entry->entry.'</td>');
										$mpdf->WriteHTML('<td class="align_right"><span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($entry->amount).'</td>');
									$mpdf->WriteHTML('</tr>');
							...
							else
							{
								...
								$mpdf->WriteHTML('<tr class="entry_list">');
									...
									$mpdf->WriteHTML('<td>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).''.$charge.'</td>');
									
									$amount=(int)$invoice_data->amount+(int)$invoice_data->discount_amount;
									
									$mpdf->WriteHTML('<td class="align_right"><span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($amount).'</td>');
								$mpdf->WriteHTML('</tr>');
				 ...
				 $mpdf->WriteHTML('<td>');
					...
					$mpdf->WriteHTML('<tbody>');
						...
						$mpdf->WriteHTML('<tr>');							
							...
							$mpdf->WriteHTML('<td class="align_right grand_total_amount"><h3 class="color_white margin">  <span>'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).'</span>'.round($grand_total).'</h3></td>');
						$mpdf->WriteHTML('</tr>');							
					$mpdf->WriteHTML('</tbody>');
					$mpdf->WriteHTML('</table>');
					...
					if(!empty($history_detail_result))
					{
						...
						$mpdf->WriteHTML('<thead>');
							...
							$mpdf->WriteHTML('<tbody>');
								...
								{					
									$mpdf->WriteHTML('<tr>');
									$mpdf->WriteHTML('<td class="align_center">'.date(MJ_amgt_date_formate(),strtotime($retrive_date->date)).'</td>');
									$mpdf->WriteHTML('<td class="align_center">'.MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )).''.$retrive_date->amount.'</td>');
...
//----------------- MEMBER ADD PAYMENT ----------------//
function MJ_amgt_member_add_payment()
{
	$mp_id = $_POST['idtest'];
	...
	$razorpay_secret_key =get_option('razorpay_secret_mid');
?>
<div class="modal-header padding_15">
...
<div class="modal-body account_popup_padding">
	<form name="payment_form" action="" method="post" class="form-horizontal" id="payment_form">
		...
		<input type="hidden" name="invoice_id" value="<?php echo esc_attr($invoice_id);?>">
		<input type="hidden" id="key_name" name="key_name" value="<?php echo esc_attr($razorpay_key); ?>">
		<input type="hidden" name="surl" id="surl" value="http://192.168.1.42/razorpay-payment-gateway-integration-using-php/success.php"> 
   		<input type="hidden" name="furl" id="furl" value="http://192.168.1.42/razorpay-payment-gateway-integration-using-php/failed.php"> 
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-sm-3 control-label form-label" for="amount"><?php esc_html_e('Paid Amount','apartment_mgt');?> (<?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?>)<span class="require-field">*</span></label>
				<div class="col-sm-8">
		...
		<div class="form-group">
			<div class="mb-3 row">	
				...
				<label class="col-sm-3 control-label form-label" for="payment_method"><?php esc_html_e('Payment By','apartment_mgt');?><span class="require-field">*</span></label>
				<div class="col-sm-8">
					 ...
					 $user_roles = $current_user->roles;
					  $user_role = array_shift($user_roles);?>
						<select name="payment_method" id="payment_method" class="form-control">
							...
							<option value="Bank Transfer"><?php esc_html_e('Bank Transfer','apartment_mgt');?></option>		
							<?php } else 
							{
				...
				<?php if($user_role != 'member'){?>
				   <div class="form-group">
						<div class="mb-3 row">	
							<label class="col-sm-3 control-label form-label" for="amount"><?php esc_html_e('Description','apartment_mgt');?></label>
							<div class="col-sm-8">
...
function MJ_amgt_load_unit_measurements()
{
...
function MJ_amgt_load_tax_amount()
{
	$tax_id=0;
	$taxpercentage=0;
	if($_REQUEST['tax_id']!='')
...
function MJ_amgt_unit_wise_view_member()
{
	  $unit_name = $_REQUEST['unit_name'];
	  $building_category = $_REQUEST['building_category'];
	  $unit_category = $_REQUEST['unit_category'];
...
function MJ_amgt_account_unit_wise_view_member()
{
	  $unit_name = $_REQUEST['unit_name'];
	  $building_category = $_REQUEST['building_category'];
	  $unit_category = $_REQUEST['unit_category'];
 ...
 function MJ_amgt_add_unit_popup()
 {
	  global $wpdb;
	  $obj_units=new MJ_amgt_ResidentialUnit;
	  echo $result=$obj_units->MJ_amgt_add_residential_unit($_POST);
	  die(); 
 }
  // amgt add member in pop-up function
function MJ_amgt_add_member_popup()
 {
...
//------------- LOAD DOCUMENT HTML -------------------// 
function MJ_amgt_load_document_html()
{ ?>
   <script>
   ...
   var file_frame;
	   ...
	   <div class="form-group">
		<div class="mb-3 row">
			...
			<div class="col-sm-2">
				<input type="text" class="form-control MJ_amgt_user_avatar_url  validate[required] onlyletter_number_space_validation" name="amgt_user_avatar[]"  
				value=" " />
			</div>	
				<div class="col-sm-2">
...
function MJ_amgt_load_document_html_frontend()
{  ?>
	<script type="text/javascript">
		$('.onlyletter_number_space_validation').keypress(function( e ) 
		{ 
	   ...
	   <div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="doc_title"><?php esc_html_e('Upload Document','apartment_mgt');?><span class="require-field">*</span></label>
				<div class="col-sm-2">
					<input id="doc_title" class="form-control validate[required] text-input " type="text" placeholder="<?php esc_html_e('Title','apartment_mgt');?>"  value="<?php if($edit) echo esc_attr($result->doc_title);?>" name="doc_title[]">
				</div>
				<div class="col-sm-1">
...
function MJ_amgt_generate_invoice_form_allmember()
{ 
 $val = $_POST['val'];
...
{  ?>
	 ...
	 <div class="form-group">
		<div class="mb-3 row">	
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="Measurement"><?php esc_html_e('Select Unit Measurement','apartment_mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
	...
	<div class="form-group">
		<div class="mb-3 row">	
			<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="amgt_email"><?php esc_html_e('Maintenance Charge','apartment_mgt');?> <span class="require-field">*</span></label>
			<div class="col-sm-8">
				<input id="maitenance_charge" class="form-control validate[required] text-input" type="text" value=""  name="maitenance_charge">
			</div>
			<div class="col-sm-1">
					<span class="font_size_20"><?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?></span>
				</div>
			</div>
	</div>
	<hr>
...
function MJ_amgt_member_wise_view_invoice()
{     
	 $obj=new MJ_amgt_Accounts;
	  $member_id=$_REQUEST['member_id'];
	  $invoice_list= $obj->MJ_amgt_get_all_unpaid_crated_invoice_memberid($member_id);
	  $array_var=array();
	  $array_var[]="<option value=''>Select Invoice</option>";
	  foreach($invoice_list as $invoice_list_data)
	  {
		$option = "<option value='".$invoice_list_data->invoice_id ."'>".$invoice_list_data->invoice_no ." - " . MJ_amgt_get_invoice_title($invoice_list_data->invoice_id) ."</option>";
	    $array_var[] = $option;
...
/* ------- view member wise invoice-----*/
function MJ_amgt_invoice_option_html()
{ 
					...
					<div class="mb-3 row">	
						...
						<div class="col-sm-8">
							...
							if($edit){
								 ...
								 $unitsarray=$obj_units->MJ_amgt_get_single_cat_units($result->unit_cat_id);
...
function MJ_amgt_charge_cal_option_html()
{ 
	...
	if($charge_cal_option == 'fix_charge')
 	...
 	?>
		...
		$(document).ready(function() {
		 ...
		 <div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="income_entry"><?php esc_html_e('Charges Payment','apartment_mgt');?> (<?php echo esc_html(MJ_amgt_get_currency_symbol(get_option( 'apartment_currency_code' )));?>)<span class="require-field">*</span></label>
				<div class="col-sm-2">
				...
				<div class="col-sm-4">
					<input id="income_entry" maxlength="50" class="form-control validate[required] margin_top_10_res text-input onlyletter_number_space_validation" type="text" value="" name="income_entry[]" placeholder="<?php esc_html_e('Charges Entry Label','apartment_mgt');?>">
				</div>			
				<div class="col-sm-2">
				<button type="button" class="btn btn-danger margin_top_10_res" onclick="deleteParentElement(this)">
				<i class="entypo-trash"><?php esc_html_e('Delete','apartment_mgt');?></i>
...
//----------------- INVOICE OPTION MAINATANCE --------------------------//
 function MJ_amgt_invoice_option_maintance()
 {
	 $invoice_option = $_POST['invoice_option'];
	 if($invoice_option == 'one_member')
	 { 
	...
	elseif ($invoice_option == 'Unit_Category_member')
	 { ?>
		...
		<div class="form-group">
			<div class="mb-3 row">	
				<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="activity_category"><?php esc_html_e('Unit Category','apartment_mgt');?></label>
				<div class="col-sm-8">
...
function MJ_amgt_visiter_checkin_details_print($visitor_checkin_id)
{
	$obj_gate=new MJ_amgt_gatekeeper;
	$result_visitor_checkin = $obj_gate->MJ_amgt_get_single_checkin($visitor_checkin_id);
	global $wpdb;	
   ...
   #printable {
	...
	<div class="modal-body invoice_body">
		<div id="invoice_print1">			
			<div class="">				
				<br>
				<p><label><b> <?php esc_html_e('GATE: ','apartment_mgt');?></b><?php 
				...
				?></label></p>
				<p><label><b> <?php esc_html_e('COMPOUND: ','apartment_mgt');?></b><?php echo esc_html(get_the_title($result_visitor_checkin->building_id)); ?></label></p>
				<p><label><b> <?php esc_html_e('UNIT CATEGORY: ','apartment_mgt');?></b><?php echo esc_html(get_the_title($result_visitor_checkin->unit_cat)); ?></label></p>
				<p><label><b> <?php esc_html_e('UNIT NUMBER: ','apartment_mgt');?></b><?php echo esc_html($result_visitor_checkin->unit_name); ?></label></p>
				<p><label><b> <?php esc_html_e('REASON FOR VISIT: ','apartment_mgt');?></b><?php echo esc_html(get_the_title($result_visitor_checkin->reason_id)); ?></label></p>
				<p><label class="margin_left_20"><b> <?php esc_html_e('VISIT DATE: ','apartment_mgt');?></b><?php echo esc_html(date(MJ_amgt_date_formate(),strtotime($result_visitor_checkin->checkin_date)));?></label>
...
function MJ_amgt_load_visitor_data_by_id()
{
	$bulding_data=array();
...
function MJ_amgt_load_document_html_member()
{  ?>
...
function MJ_amgt_import_data()
{
	...
	<div class="modal-header padding_15">
  		...
  		<h4 id="myLargeModalLabel" class="modal-title">
			<?php 
			echo esc_html__('import CSV','apartment_mgt');
