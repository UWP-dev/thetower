...
if ( is_admin() )
{
	...
	function MJ_amgt_option(){
		...
		Your account will active after the admin has approved.
...
function MJ_amgt_login_form()
{
 ...
 echo '
	...
	if (is_user_logged_in())
	{
		...
		<br/><a style="margin-left: 2%;" href="<?php echo wp_logout_url(); ?>"><?php esc_html_e('Logout','apartment_mgt');?></a> 
	  <?php
	}
	else 
	{
		wp_login_form( $args );
		echo '<a style="margin: auto;display: block;" href="'.wp_lostpassword_url().'" title="Lost Password">'.esc_html__('Forgot your password?','apartment_mgt').'</a> ';
	}
}
...
function MJ_amgt_member_registration_function()
{
    ...
    if ( isset($_POST['registration_front_member'] ) )
	{
        ...
        MJ_amgt_complete_registration($building_id,$unit_cat_id,$unit_name,$member_type,$committee_member,$first_name,$middle_name,$last_name,$gender,$birth_date,$address,$mobile,$email,$username,$password,$amgt_user_avatar);
    }
...
function MJ_amgt_complete_registration($building_id,$unit_cat_id,$unit_name,$member_type,$committee_member,$first_name,$middle_name,$last_name,$gender,$birth_date,$address,$mobile,$email,$username,$password,$amgt_user_avatar) 
{
    global $reg_errors;
	 global $building_id,$unit_cat_id,$unit_name,$member_type,$committee_member,$first_name,$middle_name,$last_name,$gender,$birth_date,$address,$mobile,$email,$username,$password,$amgt_user_avatar;
	 $amgt_user_avatar = '';	
     ...
     if ( 1 > count( $reg_errors->get_error_messages() ) ) 
	{
		...
		{
			if(!empty(get_user_meta($user_id, 'phonecode',true))){ $phone_code=get_user_meta($user_id, 'phonecode',true); }else{ $phone_code='+'.MJ_amgt_get_countery_phonecode(get_option( 'amgt_contry' )); }
...
<?php	
 echo '
	...
	.amgt_registraion_form .form-group .form-control {
	  ...
	  #member_form input[type=text],#member_form .text-input,#member_form .password
	  {
	...
	<!--- Validation Message Demo page registration --->		<script type="text/javascript"	src="<?php echo AMS_PLUGIN_URL.'/lib/validationEngine/js/jquery-validationEngine.js'; ?>"></script>	<script type="text/javascript"	src="<?php echo AMS_PLUGIN_URL.'/lib/validationEngine/js/languages/jquery.validationEngine-'.$code.'.js'; ?>"></script>	<script type="text/javascript" id="amgt-popup-js"	src="<?php echo AMS_PLUGIN_URL.'/assets/js/popup.js'; ?>"></script>	<script id="amgt-popup-front">	var amgt = {"ajax":"<?php echo admin_url('admin-ajax.php'); ?>"};	var language_translate2 = {"edit_record_alert":"Are you sure want to edit this record?","category_alert":"You must fill out the field!","class_limit_alert":"Class Limit Is Full.","enter_room_alert":"Please Enter Room Category Name.","enter_value_alert":"Please Enter Value.","delete_record_alert":"Are you sure want to delete this record?","select_hall_alert":"Please Select Exam Hall","one_record_alert":"Please Checked Atleast One Student"};	</script>		<!--- Validation Message Demo page registration end  --->
	
<!-- <script type="text/javascript" src="<?php echo esc_url( plugins_url() . '/apartment-management/assets/accordian/jquery-ui.js' ); ?>"></script>	
...
<?php
if($_REQUEST['action'] == "reg_success")
{
	?>
	<p class="success_message_reg_form ragistaion_message"><?php esc_html_e('Your registration is complete. Your account will active after admin will approve.','apartment_mgt');?></p>
	<?php
}
?>
		...
		<input type="hidden" name="role" value="<?php echo esc_attr($role);?>"  />
		    <div class="panel-body">
				...
				<div class="form-group">
					<div class="mb-3 row">	
						<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="activity_category"><?php esc_html_e('Building','apartment_mgt');?><span class="require-field">*</span></label>
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<select class="form-select validate[required] building_category width_100" name="building_id">
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="activity_category"><?php esc_html_e('Unit Category','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">			
						<select class="form-select validate[required] unit_categorys width_100" name="unit_cat_id">
			...
			<div class="form-group">
				<div class="mb-3 row">	
					<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="unit_name"><?php esc_html_e('Unit','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
						<select class="form-select validate[required] unit_name width_100" name="unit_name">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="first_name"><?php esc_html_e('First Name','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="middle_name"><?php esc_html_e('Middle Name','apartment_mgt');?></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								<input id="middle_name" class="form-control validate[custom[address_description_validation]]" type="text" maxlength="50" value="<?php if($edit){ echo esc_attr($result->middle_name);}elseif(isset($_POST['middle_name'])) echo esc_attr($_POST['middle_name']);?>" name="middle_name">
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="last_name"><?php esc_html_e('Last Name','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="gender"><?php esc_html_e('Gender','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<?php $genderval = "male"; if($edit){ $genderval=$result->gender; }elseif(isset($_POST['gender'])) {$genderval=$_POST['gender'];}?>
								...
								<label class="radio-inline margin_top_10 d-flex">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="birth_date"><?php esc_html_e('Date of birth','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="unit_name"><?php esc_html_e('Member Type','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								<select class="form-select validate[required] width_100" name="member_type" id="member_type">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label"><?php esc_html_e('Occupied By','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								<select class="form-select validate[required] allready_occupied width_100" name="occupied_by">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" ><?php esc_html_e('Occupied Date','apartment_mgt');?></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								<input id="occupied_date" class="form-control" autocomplete="off" type="text"  name="occupied_date" 
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="address"><?php esc_html_e('Address','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="email"><?php esc_html_e('Email','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="mobile"><?php esc_html_e('Mobile Number','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-sm-2 col-md-2 width_100px padding_right_0">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 width_48">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="username"><?php esc_html_e('User Name','apartment_mgt');?><span class="require-field">*</span></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="form-group">
						<div class="mb-3 row">	
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="password"><?php esc_html_e('Password','apartment_mgt');?><?php if(!$edit) {?><span class="require-field">*</span><?php }?></label>
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
								<input id="password" class="form-control <?php if(!$edit) echo 'validate[required]';?> password" type="password" minlength="8" maxlength="12" name="password" value="">
							</div>
						</div>
					</div>
					...
					<div class="form-group">	
						<div class="mb-3 row">
							<label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label form-label" for="photo"><?php esc_html_e('Image','apartment_mgt');?></label>
					...
					<div class="offset-sm-2 col-lg-8 col-md-8 col-sm-8 col-xs-12 float_left">
...
function MJ_amgt_registration_validation($building_id,$unit_cat_id,$unit_name,$member_type, $first_name,$last_name,$gender,$birth_date,$address,$mobile,$email,$username,$password)  
{
	global $reg_errors;
	$reg_errors = new WP_Error;
...
function MJ_amgt_society_rules_page()
{
	...
	{?>
		<div class="col-sm-10">
			<li>
			<h4><?php echo esc_html($rule->post_title);?></h4>
			<p><?php echo esc_html($rule->post_content);?></p>
			</li>
	...
	?>
			<ol>
				...
				{ ?>
					<div class="col-sm-10">
						<li>
						<h4><?php echo esc_html($gallary->post_title);?></h4>
						<p><?php $gallary_photos=get_post_meta($gallary->ID,'amgtfld_gallery',true); 
						...
						<?php 
						foreach($gallary_photos['image_url'] as $photo_url){?>
							<td><img src="<?php echo esc_url($photo_url);?>"></td>
						<?php } ?>
						</tr>
						</table>
						</p>
...
function MJ_amgt_install_tables()
{
	...
	$table_amgt_building_cat = $wpdb->prefix . 'amgt_building_cat';	
	 ...
	 $amgt_building_cat = $wpdb->get_results("SELECT *from $table_amgt_building_cat");
	   ...
	   $table_amgt_generat_invoice = $wpdb->prefix . 'amgt_generat_invoice';
		...
		if (!in_array($start_date_one_charge, $wpdb->get_col( "DESC " . $table_amgt_generat_invoice, 0 ) )){  $result= $wpdb->query(
		"ALTER   TABLE $table_amgt_generat_invoice  ADD   $start_date_one_charge   date");}	

		$end_date_one_charge='end_date_one_charge';
		if (!in_array($end_date_one_charge, $wpdb->get_col( "DESC " . $table_amgt_generat_invoice, 0 ) )){  $result= $wpdb->query(
		"ALTER   TABLE $table_amgt_generat_invoice  ADD   $end_date_one_charge   date");}	
		
		$one_time_recurring_option='one_time_recurring_option';
		if (!in_array($one_time_recurring_option, $wpdb->get_col( "DESC " . $table_amgt_generat_invoice, 0 ) )){  $result= $wpdb->query(
		"ALTER   TABLE $table_amgt_generat_invoice ADD $one_time_recurring_option tinyint(4) DEFAULT 0 ");}
	...
	$complain_doc='complain_doc';
		if (!in_array($complain_doc, $wpdb->get_col( "DESC " . $table_amgt_complaints, 0 ) )){  $result= $wpdb->query(
			"ALTER     TABLE $table_amgt_complaints  ADD   $complain_doc  varchar(500) NULL");}
	...
	if (!in_array($status_msg, $wpdb->get_col( "DESC " . $tbl_amgt_message_replies, 0 ) )){  
		$result= $wpdb->query("ALTER     TABLE $tbl_amgt_message_replies  ADD   $status_msg   tinyint(4) NOT NULL");
	}
}
			...
			foreach ($one_time as $recuring_chargis_data)
			{
					...
					if(!empty($member_data))
					{
						...
						{							
							...
							{
								$invoice_data['end_date']= $recuring_chargis_data->end_date_one_charge;
							}
							else
							{
...
{ 
	...
	{
		$title['title'] =__("Notice And Event","apartment_mgt");
	}
	...
	{
		$title['title'] =__("Message","apartment_mgt");
	}
...
// add_action('init' , 'my_retrieve_password_message');
// function my_retrieve_password_message( ) 
// {
// 	$display_name = "Ashish Dabhi";
...
function my_retrieve_password_message( $message, $key, $user_login, $user_data ) {
	...
	$site_url = site_url();
    $site_name = wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES );
    $message = sprintf( __( 'Hi %s' ), $user_data->display_name ) . "\r\n\r\n";
    /* translators: %s: site name */
    $message .= sprintf( __( 'This notice confirms that your password was changed on %s' ), $site_name ) . "\r\n\r\n";
    /* translators: %s: user login */
    $message .= sprintf( __( 'If you did not change your password, please contact the Site Administrator at %s' ), get_option('admin_email') ) . "\r\n\r\n";
    $message .= sprintf( __('This email has been sent to %s'), $user_data->user_email) . "\r\n\r\n";
    $message .= sprintf( 'Regards ,' ) . "\r\n\r\n";
	$message .= sprintf( __('All at %s'), $site_name) . "\r\n\r\n";
	$message .= sprintf( $site_url) . "\r\n\r\n";
