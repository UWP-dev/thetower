...
{	
	...
	public function MJ_amgt_add_sloat($data)
	{
		...
		$sloatdata['sloat_name']=MJ_amgt_strip_tags_and_stripslashes($data['sloat_name']);
		$sloatdata['sloat_type']=MJ_amgt_strip_tags_and_stripslashes($data['sloat_type']);
		$sloatdata['comment']=MJ_amgt_strip_tags_and_stripslashes($data['comment']);
	...
	public function MJ_amgt_assign_sloat($data)
	{
		...
		$assignsloatdata['vehicle_number']=MJ_amgt_strip_tags_and_stripslashes($data['vehicle_number']);
		$assignsloatdata['vehicle_model']=MJ_amgt_strip_tags_and_stripslashes($data['vehicle_model']);
		$assignsloatdata['RFID']=MJ_amgt_strip_tags_and_stripslashes($data['RFID']);
		$assignsloatdata['vehicle_type']=MJ_amgt_strip_tags_and_stripslashes($data['vehicle_type']);
		$assignsloatdata['building_id']=$data['building_id'];
		$assignsloatdata['unit_cat_id']=$data['unit_cat_id'];
		$assignsloatdata['unit_name']=MJ_amgt_strip_tags_and_stripslashes($data['unit_name']);
		...
		{
			$assignsloatdata['member_id']=$data['staff_member_id'];
		}
		$assignsloatdata['from_date']=MJ_amgt_get_format_for_db($data['from_date']);
		...
		$assignsloatdata['description']=MJ_amgt_strip_tags_and_stripslashes($data['description']);
		...
		{   //ASIGN PARKING SLOAT MAIL SEND 
			...
			$slotdata=$this->MJ_amgt_get_single_sloat($assignsloatdata['sloat_id']);
