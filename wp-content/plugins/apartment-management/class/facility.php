...
{	
	...
	public function MJ_amgt_add_facility($data)
	{
		...
		$facilitydata['facility_name']=MJ_amgt_strip_tags_and_stripslashes($data['facility_name']);
		$facilitydata['facility_charge']=MJ_amgt_strip_tags_and_stripslashes($data['facility_charge']);
	...
	public function MJ_amgt_book_facility($data)
	{
		...
		else
		{
			...
			if($result)
			{
				...
				{
					if(!empty(get_user_meta($bookdata['book_on_behalf_of'], 'phonecode',true))){ $phone_code=get_user_meta($bookdata['book_on_behalf_of'], 'phonecode',true); }else{ $phone_code='+'.MJ_amgt_get_countery_phonecode(get_option( 'amgt_contry' )); }
