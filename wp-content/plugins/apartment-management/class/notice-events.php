...
{	
   //ADD NOTICE FUNCTION
	public function MJ_amgt_add_notice($data,$file_name)
	{
		...
		$noticedata['notice_title']=MJ_amgt_strip_tags_and_stripslashes($data['notice_title']);
		$noticedata['notice_type']=MJ_amgt_strip_tags_and_stripslashes($data['notice_type']);
		$noticedata['notice_doc']=$file_name;
		$noticedata['description']=MJ_amgt_strip_tags_and_stripslashes($data['description']);
	...
	public function MJ_amgt_add_event($data,$file_name)
	{
		...
		$eventdata['event_title']=MJ_amgt_strip_tags_and_stripslashes($data['notice_title']);
		$eventdata['description']=MJ_amgt_strip_tags_and_stripslashes($data['description']);
	...
	public function MJ_amgt_approve_notice($id)
	{
		...
		if($result)
		{
			$noticeData=$this->MJ_amgt_get_single_notice($id);
