<?php
class MJ_amgt_maintenance
{	
	// ADD MAINTANCE SETTING
	public function MJ_amgt_add_maintance_settings($data)
	{
		global $wpdb;
		...
		$maintenancedata['maintenance_charges']=MJ_amgt_strip_tags_and_stripslashes($data['maintenance_charges']);
		$maintenancedata['maintenance_charge_period']=MJ_amgt_strip_tags_and_stripslashes($data['amgt_charge_period']);
	...
	public function MJ_amgt_get_all_maintenance_setings()
	{
	...
	public function MJ_amgt_get_single_maintenance_setings($id)
	{
		global $wpdb;
		$table_name = $wpdb->prefix. 'maintenance_settings';
	...
	public function MJ_amgt_get_single_maintenance_setings_bulding($id)
	{
		global $wpdb;
		$table_name = $wpdb->prefix. 'maintenance_settings';
	...
	// MAINTANCE TAX
	public function MJ_amgt_maintence_tax($id)
	{
		global $wpdb;
	...
	public function MJ_amgt_delete_maintenance_setings($id)
	{
