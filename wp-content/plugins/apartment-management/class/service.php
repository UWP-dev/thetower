...
{	
	...
	public function MJ_amgt_add_service($data)
	{
		...
		$servicedata['service_name']=MJ_amgt_strip_tags_and_stripslashes($data['service_name']);
		$servicedata['service_provider']=MJ_amgt_strip_tags_and_stripslashes($data['service_provider']);
		$servicedata['contact_number']=MJ_amgt_strip_tags_and_stripslashes($data['contact_number']);
		$servicedata['mobile_number']=MJ_amgt_strip_tags_and_stripslashes($data['mobile_number']);
		$servicedata['email']=$data['email'];
		$servicedata['address']=MJ_amgt_strip_tags_and_stripslashes($data['address']);
