...
if(isset($_REQUEST["invoice_id"]))
{
	...
	$inv_amount=0;
	/* $feepaydata = $obj_account->MJ_amgt_get_single_invoice_by_id($_REQUEST["mp_id"]);*/
	$invoiceid=$_REQUEST['invoice_id'];
	//$invoice_res = $obj_account->MJ_amgt_get_single_invoice($feepaydata->invoice_id);
	$invoice_res =$obj_payment->MJ_amgt_get_single_invoice_by_id($_REQUEST['invoice_id']);	
