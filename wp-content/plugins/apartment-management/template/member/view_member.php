	...
	<div class="col-md-12 membr_left profile_view member_border padding_none row">
	  <div class="col-md-2 left_side padding_none">
			<?php 
				...
				{ ?>
					<img class="" alt="" src="<?php echo esc_url(get_option( 'amgt_system_logo' )); ?>">
				 <?php 
				}
				else 
				{ ?>
	  ...
	  <div class="col-md-10 left_side padding_none">
		 <div class="col-md-12 col-sm-12 left_side view_data padding_none view_margin">
		   <div class="col-md-12 col-sm-12 padding_none">
			...
			<div class="col-md-12 left_side view_data d-flex">
			   <div class="col-md-1 user w-auto me-2">
	    ...
	    <div class="col-md-12 main_info_view">
		  	...
		  	<div class="member_view_row1_template">
	           <div class="col-md-12 member_border padding_none">
				 ...
				 <div class="col-md-12 col-sm-12 padding_none bank_margin row">
				 <div class="col-md-6  col-sm-12 padding_none"> 
				    <?php if($first_name){?>
					<div class="col-md-12 col-sm-12 bank_padding row p-2">
					  <div class="col-md-6 col-sm-6 bank_padding employee_weight padding_0_res">
			    ...
			    <div class="col-md-6 padding_none">
					...
					<div class="col-md-12 bank_padding row p-2">
					  ...
					  <div class="col-md-6 col-sm-6 bank_padding employee_weight padding_0_res">
					  <span class="span_left span_padding">:</span>
					  <span class="txt_color"><?php if(!empty($member_type)) { print esc_html__($str,'apartment_mgt');; }else { print '' ;}?></span>
				    </div>
				    </div>
					 <?php } ?>
...
<div class="panel-body">
	<div class="clear"></div>
		<div class="row pt-4">
		<div class="col-sm-6 col-md-6 col-12 groups-list unit_member_list_div">
		...
		{
			?>
		<div class="col-sm-6 groups-list unit_member_list_div view_user_document_list_div   margin_top_10_res">
				<div class="border float-start h-100">	
					...
					<span class="report_title"> <!-- REPORT TITLE-->
						<span class="fa-stack cutomcircle margin_bottom_10">
							<i class="fa fa-file-text fa-stack-1x" ></i>
						</span> 
					...
					<div class="my-group-list">							 
						...
						<?php
							...
							if($id_proof_1 == '' && $id_proof_2 == '' && empty($data_new[0]->value))
