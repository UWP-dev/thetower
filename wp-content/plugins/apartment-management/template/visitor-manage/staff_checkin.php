				...
				<div class="form-group">
					<div class="mb-3 row">	
						...
						<div class="col-sm-3">
							...
							value="<?php if($edit){ echo esc_attr(date("Y-m-d",strtotime($result->checkin_date)));}elseif(isset($_POST['checkin_date'])) echo esc_attr($_POST['checkin_date']); else echo date("Y-m-d");?>">
						 </div>
						 <label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="vehicle"><?php esc_html_e('Check In Time','apartment_mgt');?><span class="require-field">*</span></label>
						<div class="col-sm-3">
