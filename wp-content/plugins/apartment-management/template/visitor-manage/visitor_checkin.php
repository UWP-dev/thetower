<?php if($active_tab == 'visitor-checkin') { ?>
		...
		.dropdown-menu {
        	...
        	<?php 
			$vcheckin_id=0;
			if($obj_apartment->role=='gatekeeper' || $obj_apartment->role=='staff_member'){
				$status=1;
			}
			else{
				$status=0;
            ...
            <form name="visitor_checkin_form" action="" method="post" class="form-horizontal" id="visitor_checkin_form">
				...
				<div class="form-group">
					<div class="mb-3 row">	
						...
						<div class="col-sm-2 margin_top_10_res"><button class="btn btn-default" id="addremove" model="visit_reason_cat"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button></div>
					</div>	
				</div>
				<?php
				...
				<div class="form-group"><!--CHECK IN DATE---->
					<div class="mb-3 row">	
						<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label" for="vehicle"><?php esc_html_e('Check In Date','apartment_mgt');?><span class="require-field">*</span></label>
						<div class="col-sm-3">
						...
						<div class="col-sm-3">
							<input type="text" value="<?php if($edit){ echo esc_attr($result->checkin_time);}elseif(isset($_POST['checkintime'])) echo esc_attr($_POST['checkintime']); else date_default_timezone_set('Asia/Kolkata'); echo date("h:i a");?>" class="form-control timepicker validate[required]" name="checkintime"/>
						 </div>
					 </div>
				</div>
							...
							<div class="row padding_left_10">
								...
								<div class="form-group">
									<div class="mb-3 row">	
										...
										<label class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label form-label margin_top_10_res" for="vehicle"><?php esc_html_e('Vehicle Number','apartment_mgt');?></label>
										<div class="col-sm-3">
