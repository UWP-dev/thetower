			...
			<form name="facility_form" action="" method="post" class="form-horizontal" id="facility_form">
				...
				<div class="form-group">
					<div class="mb-3 row">	
						...
						?>
							 <label class="checkbox"><input type="checkbox" value="1" class="tog margin_right_5" name="allow_booking_multiple_base"<?php  checked( '1', $allow_booking_multiple_base);  ?>/><?php esc_html_e('Allow booking for multiple days','apartment_mgt');?></label>
						</div>
					</div>
				</div>
