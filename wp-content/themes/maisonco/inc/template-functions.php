...
if (!function_exists('maisonco_property_meta')) {
    function maisonco_property_meta() {
        $post_id  = get_the_ID();
        $bedrooms = get_post_meta($post_id, 'osf_bedrooms', true);
        $bathroom = get_post_meta($post_id, 'osf_bathroom', true);
        $floor    = get_post_meta($post_id, 'osf_floor', true);
        if (!empty($bedrooms)) {
            echo '<span>' . $bedrooms . ' ' . esc_html__('Bedrooms', 'maisonco') . '</span>';
        }
        if (!empty($bathroom)) {
            echo '<span>' . $bathroom . ' ' . esc_html__('bathroom', 'maisonco') . '</span>';
        }
        if (!empty($floor)) {
            echo '<span>' . $floor . ' ' . esc_html__('Floor', 'maisonco') . '</span>';
        }
