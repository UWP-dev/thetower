...
if (isset($_REQUEST['STATUS']) && $_REQUEST['STATUS'] == 'TXN_SUCCESS') {
    ...
    if ($result) {
        ...
        wp_redirect(home_url() . 'user-dashboard/?apartment-dashboard=user&page=accounts&tab=invoice-list&action=success');
...
<div id="eventContent" class="modal-body" style="display:none;"><!--MODAL BODY DIV START-->
    ...
    <style>
        button.ui-dialog-titlebar-close {
            ...
            background-image: url(https://www.thetowersatharborcourt.com/wp-content/plugins/apartment-management/assets/images/Close.png);
        ...
        #form_list1 thead>tr>th:first-child.sorting {
...
<head>
    ...
    <script>
        jQuery(document).ready(function($) {
            $('#form_list1').DataTable();
            $('#owner_list1').DataTable();
            $('#maintenanceservices_list1').DataTable();
            $('#buildingoperations_list1').DataTable();
            $('#officialdocuments_list1').DataTable();
            $('#boardofdirectors_list1').DataTable();
            $('#announcements_list1').DataTable();
            $('.menu-sec.navbar-nav li').click(function() {
                // Remove 'active' class from all li elements
                $('.menu-sec.navbar-nav li').removeClass('active');
                ...
                <li class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu extended logout" aria-labelledby="dropdownMenufront">
                        ...
                        <li>
                            ...
                            <a class="dropdown-item" href="?apartment-dashboard=user&pages=profile"><i class="fa fa-user"></i>
                        ...
                        <li>
                            ...
                            <a class="dropdown-item" href="<?php echo wp_logout_url(home_url()); ?>"><i class="fa fa-sign-out m-r-xs"></i><?php esc_html_e('Log Out', 'apartment_mgt'); ?>
        ...
        <div class="row responsive_add_main_front_end">
            ...
            <div class="col-sm-2 col-md-2 col-12 nopadding apartment_left nav-side-menu"> <!--  Left Side -->
                ...
                <ul class="menu-sec navbar-nav nav nav-pills nav-stacked out collapse navbar-collapse responsive_nav_bar_frontend" id="menu-content">
                    ...
                    <?php if ($_REQUEST['pages'] == 'forms' ||  $_REQUEST['pages'] == 'owner_tanents') {
                        $class = 'class = "active nav-item"';
                    } else {
                        $class = "";
                    }
                    ...
                    <?php if ($_REQUEST['pages'] == '') {
                        $class1 = 'class = "active nav-item"';
                    }
                    ?>
                    <li <?php echo $class1; ?>>
                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/'; ?>">
                            <span class="icone">
                                <img src="<?php echo plugins_url('apartment-management/assets/images/icon/dashboard.png') ?>" />
                            </span>
                            <span class="title"><?php esc_html_e('Dashboard', 'apartment_mgt'); ?></span>
                        </a>
                    </li>
                    ...
                    foreach ($menu as $key1 => $value1) {
                        ...
                        foreach ($value1 as $key => $value) {
                            ...
                            if ($value['view'] == '1') {
                                ...
                                if (isset($_REQUEST['pages']) && $_REQUEST['pages'] == $value['page_link']) {
                                    $class = 'class = "active nav-item"';
                                } else {
                                    $class = "";
                                }
                                if ($value['page_link'] == "notice-event") {
                                    echo '<li ' . $class . '><a class="nav-link px-3" href="?apartment-dashboard=user&pages=' . $value['page_link'] . '" ><span class="icone"> <img src="' . $value['menu_icone'] . '" /></span><span class="title">' . MJ_amgt_change_menutitle($key) . '</span></a></li>';

                                    ?>
                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=forms'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/02/form_ico.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Resident Forms', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>

                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=owner_tanents'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/03/owner-1.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Owner/Tenants Essentials', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>
                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=maintenance-services'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/03/maintainance-services.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Maintenance Services', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>

                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=building-operations'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/03/building-icon.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Building Operations', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>

                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=official-documents'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/03/document-icon1.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Official Documents', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>
                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=board-of-directors'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/03/bod-icon.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Board of Directors', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>
                                    <li <?php echo $class; ?>>
                                        <a class="nav-link px-3" href="<?php echo site_url() . '/user-dashboard/?apartment-dashboard=user&pages=announcements'; ?>">
                                            <span class="icone">
                                                <img src="/wp-content/uploads/2024/03/announcement-1.png" />
                                            </span>
                                            <span class="title"><?php esc_html_e('Announcements', 'apartment_mgt'); ?></span>
                                        </a>
                                    </li>
                                    <?php
                                        } else {
            ...
            <div class="col-sm-10 col-md-10 col-12 page-inner innerpage_div">
                ...
                <div class="right_side <?php if (isset($_REQUEST['pages'])) echo esc_attr($_REQUEST['pages']); ?>">
                    ...
                    if (isset($_REQUEST['pages'])) {
                        ...
                        if ($_REQUEST['pages'] == 'forms') {
                            echo do_shortcode('[custom_forms_table]');
                    ?>
                        <?php
                            return false;
                        }
                        if ($_REQUEST['pages'] == 'owner_tanents') {
                            echo do_shortcode('[custom_owner_tenants_table]');
                        ?>
                        <?php
                            return false;
                        }
                        if ($_REQUEST['pages'] == 'maintenance-services') {
                            echo do_shortcode('[custom_maintenance_services_table]');
                        ?>
                        <?php
                            return false;
                        }
                        if ($_REQUEST['pages'] == 'building-operations') {
                            echo do_shortcode('[custom_building_operations_table]');
                        ?>
                        <?php
                            return false;
                        }
                        if ($_REQUEST['pages'] == 'official-documents') {
                            echo do_shortcode('[custom_official_documents_table]');
                        ?>
                        <?php
                            return false;
                        }
                        if ($_REQUEST['pages'] == 'board-of-directors') {
                            echo do_shortcode('[custom_board_of_directors_table]');
                        ?>
                        <?php
                            return false;
                        }
                        if ($_REQUEST['pages'] == 'announcements') {
                            echo do_shortcode('[custom_announcements_table]');
                        ?>
                        <?php
                            return false;
                        }
                        if( $_REQUEST['pages'] == 'message' ){
                            require_once get_stylesheet_directory() . '/apartment-management/' . $_REQUEST['pages'] . '/' . $_REQUEST['pages'] . '.php';
                            return false;
                        }
                        if (in_array($_REQUEST['pages'], $access_page_view_array)) {
                            require_once AMS_PLUGIN_DIR . '/template/' . $_REQUEST['pages'] . '/' . $_REQUEST['pages'] . '.php';
                            return false;
                        } else {
                                ...
                                ?>
                                    ...
                                    <div class="panel panel-white event operation dasboard_notice">
                                        ...
                                        <div class="panel-heading ">
                                            ...
                                            <h3 class="panel-title notice_event_flot"><?php esc_html_e('Notice', 'apartment_mgt'); ?><span class="float_right"><a href="<?php echo home_url() . 'user-dashboard/?apartment-dashboard=user&page=notice-event'; ?>"><i class="fa fa-align-justify" aria-hidden="true"></i></a></span></h3>
                                ...
                                ?>
                                    ...
                                    <div class="panel panel-white event assignbed dasboard_invoice">
                                        ...
                                        <div class="panel-heading">
                                            ...
                                            <h3 class="panel-title notice_event_flot"><?php esc_html_e('Invoice ', 'apartment_mgt'); ?><span class="float_right"><a href="<?php echo home_url() . 'user-dashboard/?apartment-dashboard=user&page=accounts'; ?>"><i class="fa fa-align-justify" aria-hidden="true"></i></a></span></h3>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="building_id border_bottom_1_dash"><?php echo MJ_amgt_get_currency_symbol(get_option('apartment_currency_code'));
                                                                                                                    echo esc_html($total_amount); ?></td>
